...
export const HOTKEYS: HotkeyDef[] = [
  {
    ...
    group: "Navigation",
    label: "Focus search",
    description: "Jump to the top-bar search from anywhere.",
    defaultBinding: "/",
  },
  {
    ...
    group: "Navigation",
    label: "Open settings",
    description: "Open Bear's settings outside playback.",
  ...
  },
  {
    ...
    description: "Make Bear's interface larger.",
    defaultBinding: "ctrl+=",
  },
  {
    id: "globalUiScaleDown",
    scope: "Global",
    group: "Interface",
    label: "Decrease interface scale",
    description: "Make Bear's interface smaller.",
    defaultBinding: "ctrl+-",
  },
  {
    id: "globalUiScaleReset",
    scope: "Global",
    group: "Interface",
    label: "Reset interface scale",
    description: "Restore Bear's interface scale to 100%.",
...

  {
    ...
    group: "Playback",
    label: "Close player",
    description: "Exit playback and return to the previous view.",
  ...
  },
  {
    ...
    description: "Show or hide the playback stats overlay.",
    defaultBinding: "i",
  },
  {
    id: "playerCrop",
    ...
    description: "Cycle aspect and crop modes: Fit, Fill, Zoom, 16:9, 4:3, Original.",
    defaultBinding: "v",
  },
  {
    id: "playerPanscanDown",
    scope: "Player",
    group: "Playback",
    label: "Zoom out",
    description: "Step zoom out to restore baked-in black bars (Zoom mode).",
    defaultBinding: "-",
  },
  {
    id: "playerPanscanUp",
    ...
    group: "Playback",
    label: "Zoom in",
    description: "Step zoom in to crop baked-in black bars (Zoom mode).",
    defaultBinding: "=",
  },
  {
    id: "playerScreenshot",
    ...
    group: "Playback",
    label: "Screenshot",
    description: "Save the current frame (video only, no subtitles) as a PNG to Pictures/Bear.",
    defaultBinding: "p",
  },
  {
    id: "playerGifRecord",
    ...
    label: "Record GIF",
    description:
      "Start or stop recording a GIF of the video (no subtitles). Saves to Pictures/Bear.",
    defaultBinding: "o",
  },
  {
    id: "playerClipRecord",
    ...
    description:
      "Save the last 30 seconds as a video clip with audio, choosing subtitles on or off. Saves to Pictures/Bear.",
    defaultBinding: "c",
  },
  {
