...
export const HOTKEYS: HotkeyDef[] = [
  ...
  { id: "globalUiScaleUp", scope: "Global", group: "Interface", label: "Increase interface scale", description: "Make Bear's interface larger.", defaultBinding: "ctrl+=" },
  { id: "globalUiScaleDown", scope: "Global", group: "Interface", label: "Decrease interface scale", description: "Make Bear's interface smaller.", defaultBinding: "ctrl+-" },
  { id: "globalUiScaleReset", scope: "Global", group: "Interface", label: "Reset interface scale", description: "Restore Bear's interface scale to 100%.", defaultBinding: "ctrl+0" },
  ...
  { id: "playerScreenshot", scope: "Player", group: "Playback", label: "Screenshot", description: "Save the current frame (video only, no subtitles) as a PNG to Pictures/Bear.", defaultBinding: "p" },
  { id: "playerGifRecord", scope: "Player", group: "Playback", label: "Record GIF", description: "Start or stop recording a GIF of the video (no subtitles). Saves to Pictures/Bear.", defaultBinding: "o" },
  { id: "playerClipRecord", scope: "Player", group: "Playback", label: "Save video clip", description: "Save the last 30 seconds as a video clip with audio, choosing subtitles on or off. Saves to Pictures/Bear.", defaultBinding: "c" },
...

  {
    ...
    group: "Seeking",
    label: "Seek back",
    description: "Jump back by the Back seek step set under Behavior.",
    defaultBinding: "ArrowLeft",
  },
  {
    id: "playerSeekForward10",
    scope: "Player",
    group: "Seeking",
    label: "Seek forward",
  ...
  },
  {
    ...
    group: "Seeking",
    label: "Seek back 30s",
    description: "Jump back thirty seconds.",
    defaultBinding: ",",
  },
  {
    id: "playerSeekForward30",
    scope: "Player",
    group: "Seeking",
    label: "Seek forward 30s",
    description: "Jump forward thirty seconds.",
    defaultBinding: ".",
  },
  {
    id: "playerFrameBack",
    ...
    description: "Step back one frame and pause. Frame-accurate on mpv.",
    defaultBinding: "shift+<",
  },
  {
    id: "playerFrameForward",
    scope: "Player",
    group: "Seeking",
    label: "Next frame",
    description: "Step forward one frame and pause. Frame-accurate on mpv.",
    defaultBinding: "shift+>",
  },
  {
    id: "playerStart",
  ...
  },
  {
    ...
    group: "Seeking",
    label: "Jump to end",
    description: "Seek to the last half second.",
    defaultBinding: "End",
  },

  {
    ...
    group: "Volume",
    label: "Volume up",
    description: "Raise volume (hold Shift for big steps).",
  ...
  },
  {
    ...
    group: "Volume",
    label: "Volume down",
    description: "Lower volume (hold Shift for big steps).",
  ...
  {
    id: "playerSubtitleCycle",
    scope: "Player",
    group: "Tracks",
    label: "Cycle subtitles",
    description: "Cycle through available subtitle tracks.",
    defaultBinding: "s",
  },
  {
    id: "playerSubtitleCycleAlt",
    scope: "Player",
    group: "Tracks",
    label: "Cycle subtitles (alt)",
    description: "A second binding for the same action so muscle memory survives.",
    defaultBinding: "c",
  },
  {
    id: "playerSubDelayDown",
    scope: "Player",
    group: "Tracks",
    label: "Subtitle delay −0.1s",
    description: "Shift subtitle timing earlier (Shift for fine steps).",
    defaultBinding: "z",
  },
  {
    id: "playerSubDelayUp",
    ...
    group: "Tracks",
    label: "Subtitle delay +0.1s",
    description: "Shift subtitle timing later (Shift for fine steps).",
    defaultBinding: "x",
  },

  {
    id: "playerNextEpisode",
    scope: "Player",
    group: "Navigation",
    label: "Next episode",
    description: "Skip to the next episode if available.",
    defaultBinding: "n",
  },
  {
    id: "playerPrevEpisode",
    scope: "Player",
    group: "Navigation",
    label: "Previous episode",
    description: "Skip to the previous episode if available.",
    defaultBinding: "b",
  },
  {
    id: "playerPrevChannel",
    scope: "Player",
    group: "Navigation",
    label: "Previous channel",
    description: "Jump back to the last live channel you watched (live TV only).",
    defaultBinding: "h",
  },

  {
    ...
    group: "Speed",
    label: "Speed down",
    description: "Slow playback by 0.25x.",
    defaultBinding: "[",
  },
  {
    id: "playerSpeedUp",
    ...
    group: "Speed",
    label: "Speed up",
    description: "Speed playback up by 0.25x.",
    defaultBinding: "]",
  },

  {
    id: "playerStreamSwitcher",
    scope: "Player",
    group: "Panels",
    label: "Stream switcher",
    description: "Open or close the in-player stream switcher.",
    defaultBinding: "w",
  },
  {
    ...
    description: "Open or close the episode panel.",
    defaultBinding: "e",
  },
  {
    id: "playerTvGuide",
    ...
    group: "Panels",
    label: "TV guide",
    description: "Open or close the live TV guide (live channels only).",
    defaultBinding: "g",
  },
  {
    id: "playerDvr",
    ...
    group: "Panels",
    label: "DVR / record",
    description: "Open or close the live TV recorder (live channels only).",
    defaultBinding: "r",
  },
  {
    id: "playerSleep",
