...
export const DEFAULT: Settings = {
  ...
  playerShaders: {},
  preferredSubLangs: ["Arabic"],
  preferredAudioLangs: ["Arabic", "English", "Japanese"],
  subFontSize: 32,
  subFontColor: "#FFFFFF",
  ...
  tmdbLanguage: "ar-SA",
  tmdbImageLangs: ["Arabic", "Original"],
  nfoPosterSize: "w500",
  ...
  pickerShowFilename: true,
  pickerRefreshNextToBack: true,
  customStreamFilters: [],
