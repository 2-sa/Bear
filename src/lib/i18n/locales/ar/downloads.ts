const downloads: Record<string, string> = {
  ...
  "Or set a series to auto-download": "أو أضف مسلسلًا للتنزيل التلقائي",
  "Auto-download": "التنزيل التلقائي",
  "New episodes grab themselves in the background": "تُنزَّل الحلقات الجديدة تلقائيًا في الخلفية",
  ...
  "Add a series above and Bear will grab each new episode as it airs, on your terms.":
    "أضف مسلسلًا أعلاه وسينزّل Bear كل حلقة جديدة عند عرضها وفق إعداداتك.",
  ...
  "Point Bear at a folder. We scan it for movies and shows, parse titles from filenames, and enrich them with TMDB so they look the same as everything else here. We just remember the path; nothing is copied or moved.":
    "وجّه Bear إلى مجلد. نفحصه بحثًا عن الأفلام والمسلسلات، ونستخرج العناوين من أسماء الملفات، ونُثريها بـ TMDB لتبدو مثل كل شيء آخر هنا. نتذكّر المسار فقط؛ لا يُنسخ أو يُنقل شيء.",
