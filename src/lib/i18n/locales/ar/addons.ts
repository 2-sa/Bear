const addons: Record<string, string> = {
  ...
  "Anything you install in Bear pushes back to your Stremio account so it shows up on mobile too. Sign in via the avatar in the bottom-left of the sidebar.":
    "كل إضافة تثبّتها في بير تُحفظ أيضًا في حساب ستريميو، فتظهر على هاتفك كذلك. سجّل الدخول من صورة الملف الشخصي أسفل الشريط الجانبي.",
  Starters: "البدايات",
  ...
  "Click to open {name}'s setup page in Bear's built-in browser. Pick your options. When you click Install on their page, Bear catches the link automatically and updates the addon.":
    "انقر لفتح صفحة إعداد {name} في متصفّح Bear المدمج. اختر خياراتك. عند النقر على تثبيت في صفحتها، يلتقط Bear الرابط تلقائيًا ويحدّث الإضافة.",
  ...
  "Heads-up: a few addons (like AIOStatus) don't pre-fill from the URL. If the form loads blank, paste the existing manifest URL into their \"Import from URL\" field to restore your settings.":
    "تنبيه: بعض الإضافات (مثل AIOStatus) لا تُملأ مسبقًا من الرابط. إذا حُمّل النموذج فارغًا، فالصق رابط ملف تعريف الإضافة الحالي في حقل «الاستيراد من رابط» لاستعادة إعداداتك.",
  ...
  "Reading manifest": "قراءة ملف تعريف الإضافة",
  "Reading new manifest": "قراءة ملف تعريف الإضافة الجديد",
  ...
  "Manifest URL copied": "تم نسخ رابط ملف تعريف الإضافة",
  ...
  "Pulled from manifest": "مأخوذة من ملف تعريف الإضافة",
  Version: "الإصدار",
  Resources: "الموارد",
  Types: "الأنواع",
  ...
  Yes: "نعم",
  No: "لا",
  "Manifest URL": "رابط ملف تعريف الإضافة",
  Copy: "نسخ",
  Reveal: "إظهار",
  ...
  "Hidden by default. Manifest paths often carry API keys (debrid tokens, OMDB keys, etc.) you don't want over a shoulder.":
    "مخفي افتراضيًا. غالبًا ما تتضمن روابط ملفات تعريف الإضافات مفاتيح API (مثل رموز ديبريد ومفاتيح OMDB)، لذلك لا تعرضها أمام الآخرين.",
  "Stremio addon, packaged into Bear's catalog.": "إضافة Stremio، مُدمجة في كتالوج Bear.",
  "Version and capabilities come straight from the addon's manifest. Ratings and categories come from the":
    "يأتي الإصدار والإمكانات مباشرة من ملف تعريف الإضافة، وتأتي التقييمات والفئات من",
  ...
  "Trending tracks star growth across your Bear visits. Open the addons page again tomorrow and the top risers will appear here.":
    "يتتبّع الرائج نمو النجوم عبر زياراتك لـ Bear. افتح صفحة الإضافات مرة أخرى غدًا وستظهر هنا أكثر الإضافات صعودًا.",
  New: "جديد",
  ...
  "These live in Bear on this computer and never touch your account.":
    "توجد هذه في Bear على هذا الحاسوب ولا تمسّ حسابك أبدًا.",
  ...
  "Bear double-checks with Stremio after saving, so a half-written order can't slip through.":
    "يتحقّق Bear مرتين مع Stremio بعد الحفظ، حتى لا يتسلّل ترتيب مكتوب جزئيًا.",
  ...
  "Saved, but Bear couldn't confirm the new order. Retry to re-check.":
    "تم الحفظ، لكن تعذّر على Bear تأكيد الترتيب الجديد. أعد المحاولة للتحقّق.",
  "Stremio reports a different order than was saved.": "يُبلّغ Stremio عن ترتيب مختلف عمّا حُفظ.",

  "A safety copy of your addon order. One is saved automatically before Bear writes any change, and you can save one yourself any time. The five most recent are kept.":
    "نسخة أمان من ترتيب إضافاتك. تُحفظ واحدة تلقائيًا قبل أن يكتب Bear أي تغيير، ويمكنك حفظ واحدة بنفسك في أي وقت. يُحتفظ بأحدث خمس نسخ.",
  ...
  "Paste manifest URL or stremio:// link": "الصق رابط ملف تعريف الإضافة أو رابط stremio://‎",
  "Install from URL: paste any manifest or stremio:// link":
    "التثبيت من رابط: الصق رابط ملف تعريف إضافة أو رابط stremio://‎",
  ...
  "Click below to open {name}'s setup page in Bear's built-in browser. Pick your options. When you click Install on their page, Bear catches the link automatically and updates the addon.":
    "انقر أدناه لفتح صفحة إعداد {name} في متصفّح Bear المدمج. اختر خياراتك. عند النقر على تثبيت في صفحتها، يلتقط Bear الرابط تلقائيًا ويحدّث الإضافة.",
  ...
  "Free torrent + usenet": "تورنت ويوزنت مجانيان",
