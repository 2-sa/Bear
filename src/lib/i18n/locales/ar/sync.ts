const sync: Record<string, string> = {
  ...
  "Show your AniList lists as rails on the Anime page, keep your watch progress in sync as you finish episodes, and use your AniList avatar as your Bear photo. Free at anilist.co.": "اعرض قوائم AniList الخاصة بك كصفوف في صفحة الأنمي، واحتفظ بمزامنة تقدم المشاهدة عند إكمالك للحلقات، واستخدم صورتك الشخصية على AniList كصورة في Bear. مجانًا على anilist.co.",
  "Connect AniList": "ربط AniList",
  "About AniList": "حول AniList",
  "Connected": "متصل",
  "Bear shows your AniList lists on the Anime page and keeps your progress in sync.": "يعرض Bear قوائم AniList الخاصة بك في صفحة الأنمي ويُبقي تقدمك متزامنًا.",
  "Authorized": "مُصرّح",
  ...
  "Use my AniList avatar as my Bear avatar": "استخدام صورتي في AniList كصورتي في Bear",
  "Show your AniList profile picture as your Bear avatar.": "عرض صورتك الشخصية على AniList كصورتك في Bear.",
