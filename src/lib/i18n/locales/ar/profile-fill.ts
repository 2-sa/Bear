const profileFill: Record<string, string> = {
  ...
  "Ratings need a Bear account": "التقييمات تتطلب حساب بير",
  "Your Bear account is separate from your Stremio sign in. Create one free or sign in from Settings.": "حساب بير منفصل عن تسجيل دخولك في ستريميو. أنشئ حسابًا مجانًا أو سجّل الدخول من الإعدادات.",
  ...
  "Couldn't reach Bear, check your connection": "تعذّر الوصول إلى Bear، تحقّق من اتصالك",
  "Bear is having trouble, try again in a moment": "يواجه Bear مشكلة، حاول مرة أخرى بعد لحظة",
  "Ratings": "التقييمات",
  ...
  "Bear list": "قائمة Bear",
  "Share list": "مشاركة القائمة",
  "List link": "رابط القائمة",
  "{title} on Bear": "{title} على Bear",
  ...
  "Something went wrong reaching Bear. Check your connection and try again.": "حدث خطأ أثناء الاتصال بـ Bear. تحقّق من اتصالك وحاول مرة أخرى.",
