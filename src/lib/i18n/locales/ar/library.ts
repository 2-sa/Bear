const library: Record<string, string> = {
  ...
  "Right-click any title in Bear or hit \"Add to Watchlist\" on its detail page to save it here.":
    "انقر بزرّ الفأرة الأيمن على أي عنوان في Bear أو اضغط \"إضافة إلى قائمة المشاهدة\" في صفحة تفاصيله لحفظه هنا.",
