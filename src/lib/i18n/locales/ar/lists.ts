const lists: Record<string, string> = {
  ...
  "Paste a public list from Trakt, MDBList, TMDB, Letterboxd, IMDb, or MyAnimeList. Bear pulls the titles in and keeps the artwork sharp.":
    "الصق قائمة عامة من Trakt أو MDBList أو TMDB أو Letterboxd أو IMDb أو MyAnimeList. يجلب Bear العناوين ويبقي الصور حادّة.",
