const together: Record<string, string> = {
  ...
  "A relay is a tiny Cloudflare Worker that passes play/pause/seek messages between you and your friends. No video data ever touches it. Deploy your own in one click (free tier is plenty), or paste a friend's invite link to use theirs.": "خادم المشاهدة معًا هو Cloudflare Worker صغير ينقل أوامر التشغيل والإيقاف والتقديم بينك وبين أصدقائك، ولا تمر عبره أي بيانات فيديو. انشر خادمك بنقرة واحدة — فالخطة المجانية تكفي — أو الصق رابط دعوة من صديق لاستخدام خادمه.",
  "Watch Together": "المشاهدة معاً",
};
