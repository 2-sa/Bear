const settingsFill: Record<string, string> = {
  "Your avatar, name, and handle across Bear.": "Seu avatar, nome e identificador em todo o Bear.",
  ...
  "SVP's files are here but its VapourSynth engine won't load ({err}). This usually means a stale VapourSynth entry or a missing Microsoft VC++ runtime. Reinstall SVP, or install the latest \"Visual C++ Redistributable (x64)\" from Microsoft, then reopen Bear.": "Os arquivos do SVP estão aqui, mas o mecanismo VapourSynth dele não carrega ({err}). Isso geralmente indica uma entrada obsoleta do VapourSynth ou a ausência do runtime Microsoft VC++. Reinstale o SVP ou instale a versão mais recente do \"Visual C++ Redistributable (x64)\" da Microsoft e reabra o Bear.",
  "Smooth motion runs on the bundled mpv engine in the Bear desktop app. It has no effect in the browser.": "O movimento suave é executado no mecanismo mpv integrado ao aplicativo de desktop do Bear. Não tem efeito no navegador.",
  ...
  "For the hardest files and the Try again button, Bear transcribes a little speech on your device and lines the subtitle up to the actual words. Needs a build with the asr-whisper feature and downloads a small model the first time you use it.": "Para os arquivos mais difíceis e o botão Tentar novamente, o Bear transcreve um trecho da fala no seu dispositivo e alinha a legenda às palavras reais. Requer uma compilação com o recurso asr-whisper e baixa um modelo pequeno na primeira vez que você o usa.",
  "Community sync": "Sincronização da comunidade",
  "A good correction only has to be found once. Bear can share verified fixes so the next person with the same file and subtitle gets an instant result. Records are keyed by salted fingerprints, never your files or anything personal.": "Uma boa correção só precisa ser encontrada uma vez. O Bear pode compartilhar correções verificadas para que a próxima pessoa com o mesmo arquivo e a mesma legenda obtenha um resultado instantâneo. Os registros são indexados por impressões digitais salgadas, nunca pelos seus arquivos nem por nada pessoal.",
  ...
  "Leave blank to use Bear's own community server. Enter a URL to point at your own server instead. Private mode below stops all contact either way.": "Deixe em branco para usar o próprio servidor da comunidade do Bear. Insira uma URL para apontar para o seu próprio servidor. O modo privado abaixo interrompe todo contato de qualquer forma.",
  ...
  "Bear ships a neutral trophy for every award. Install an icon pack or upload your own image per award to make them yours. Packs are hosted by whoever makes them, so the artwork is theirs, not bundled with Bear.": "O Bear inclui um troféu neutro para cada prêmio. Instale um pacote de ícones ou envie a sua própria imagem para cada prêmio para torná-los seus. Os pacotes são hospedados por quem os cria, então a arte é deles, não vem incluída no Bear.",
  ...
  "An award pack is a single JSON file plus the images it points to. Host both anywhere public (your own server, a GitHub repo, etc.) and share the JSON URL. Bear only stores the URLs you install, never the images.": "Um pacote de prêmios é um único arquivo JSON mais as imagens que ele referencia. Hospede ambos em qualquer lugar público (o seu próprio servidor, um repositório do GitHub, etc.) e compartilhe a URL do JSON. O Bear armazena apenas as URLs que você instala, nunca as imagens.",
  ...
  "Name each image file after its award ID and put them in a .zip, then use \"Import a .zip pack\" above. No JSON, no hosting needed. Bear matches each file to its award, stores it locally, resizes it, and skips anything it doesn't recognize.": "Nomeie cada arquivo de imagem com o ID do seu prêmio e coloque-os em um .zip, depois use \"Importar um pacote .zip\" acima. Sem JSON, sem necessidade de hospedagem. O Bear associa cada arquivo ao seu prêmio, armazena-o localmente, redimensiona-o e ignora tudo o que não reconhece.",
  ...
  "Turns the season button into a full panel: order tabs (Aired, DVD, Absolute, and any the show has) plus a season table with air-date ranges and episode counts. On by default for anime through Bear's TVDB service, no key needed. Add your own TVDB key to use it for regular shows too.": "Transforma o botão de temporada em um painel completo: abas de ordenação (Exibição, DVD, Absoluta e qualquer outra que a série tenha) mais uma tabela de temporadas com intervalos de datas de exibição e contagem de episódios. Ativado por padrão para anime através do serviço TVDB do Bear, sem necessidade de chave. Adicione sua própria chave TVDB para usá-lo em séries comuns também.",
  ...
  "Looking for Bear in your browser, the phone remote, or the manga reader remote? They moved to the Remotes page.": "Procurando o Bear no seu navegador, o controle remoto do celular ou o controle remoto do leitor de mangá? Eles foram movidos para a página Controles Remotos.",
  ...
  "After 4": "Após 4",
  "After 5": "Após 5",
  "Remotes are served by the desktop app. Open these settings on your computer's Bear to get the links.": "Os controles remotos são fornecidos pelo aplicativo de desktop. Abra estas configurações no Bear do seu computador para obter os links.",
  "Bear on other devices": "Bear em outros dispositivos",
  "Serve Bear on your network": "Disponibilizar o Bear na sua rede",
  ...
  "While beta updates are on, Bear offers the newest build again on its next check. Turn beta updates off above to stay on an earlier one.": "Enquanto as atualizações beta estiverem ativadas, o Bear volta a oferecer a versão mais recente na próxima verificação. Desative as atualizações beta acima para permanecer em uma versão anterior.",
  "Picture shaders run on the bundled mpv engine in the Bear desktop app. They have no effect in the browser.": "Os shaders de imagem são executados no motor mpv integrado ao aplicativo Bear para desktop. Eles não têm efeito no navegador.",
  ...
  "Neural upscalers, sharpeners, and HDR tone-mapping ported for mpv. Each is hosted by its author, not bundled with Bear. Download the ones you want; Bear chains them in the right order and applies them in the player.": "Upscalers neurais, filtros de nitidez e mapeamento de tons HDR portados para o mpv. Cada um é hospedado pelo seu autor, não incluído no Bear. Baixe os que quiser; o Bear os encadeia na ordem certa e os aplica no player.",
  "Cleared": "Limpo",
  "Sure?": "Tem certeza?",
  "Storage overview": "Visão geral do armazenamento",
  "Everything Bear saves lives on this computer. If space runs low, clear a cache below; Bear rebuilds them as you browse.": "Tudo o que o Bear salva fica neste computador. Se faltar espaço, limpe um cache abaixo; o Bear os reconstrói conforme você navega.",
  ...
  "Sources Bear flagged as broken. Clear to give them another chance.": "Fontes que o Bear marcou como quebradas. Limpe para dar outra chance a elas.",
  ...
  "Bear searches every source you enable at the same time, then merges and de-duplicates the results into one clean list. Turn a source off to stop pulling from it.": "O Bear pesquisa ao mesmo tempo todas as fontes que você ativa, depois mescla os resultados e remove as duplicatas em uma única lista organizada. Desative uma fonte para parar de buscar resultados nela.",
  "OpenSubtitles": "OpenSubtitles",
  "Bear's built-in OpenSubtitles search, on by default. If you install an OpenSubtitles addon, this steps aside automatically so your results are never duplicated.": "A busca de OpenSubtitles integrada ao Bear, ativada por padrão. Se você instalar um addon do OpenSubtitles, ela se desativa automaticamente para que seus resultados nunca sejam duplicados.",
  "Wyzie": "Wyzie",
  ...
  "What fills the hero. Trending is a fresh top list from Bear, refreshed through the day. Classic uses your own Home rows.": "O que preenche o destaque. Em alta é uma nova lista dos mais populares do Bear, atualizada ao longo do dia. Clássico usa as suas próprias linhas da tela Início.",
  "Classic": "Clássico",
  "Screensaver": "Proteção de tela",
  "When Bear sits idle in the foreground, it drifts through cinematic backdrops with a clock and what's trending. Any movement or key brings you back. Off by default.": "Quando o Bear fica ocioso em primeiro plano, ele desliza por cenários cinematográficos com um relógio e o que está em alta. Qualquer movimento ou tecla traz você de volta. Desativado por padrão.",
  ...
  "Choose where you can grab Bear to drag it around your screen.": "Escolha onde você pode pegar o Bear para arrastá-lo pela tela.",
  "Native-style hybrid bar": "Barra híbrida de estilo nativo",
  "Turn off the native window title bar above to use Bear's hybrid bar instead.": "Desative a barra de título nativa da janela acima para usar a barra híbrida do Bear em vez dela.",
  "Tuck clean, native-looking window buttons into the top corner, with hover labels. On macOS they become traffic-light dots. Blends into Bear while feeling like your system's own title bar.": "Encaixa botões de janela limpos e com aparência nativa no canto superior, com rótulos ao passar o mouse. No macOS, eles se tornam pontos de semáforo. Combina com o Bear e ao mesmo tempo parece a barra de título do seu próprio sistema.",
  ...
  "Move Bear by dragging any empty space on a page, not just the top bar. Leave this off to keep clicks inside pages from nudging the window.": "Mova o Bear arrastando qualquer espaço vazio de uma página, não apenas a barra superior. Deixe desativado para evitar que cliques dentro das páginas movam a janela sem querer.",
