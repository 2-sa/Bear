const addons: Record<string, string> = {
  ...
  "Click to open {name}'s setup page in Bear's built-in browser. Pick your options. When you click Install on their page, Bear catches the link automatically and updates the addon.": "Clique para abrir a página de configuração do {name} no navegador integrado do Bear. Escolha suas opções. Quando você clicar em Instalar na página deles, o Bear captura o link automaticamente e atualiza o addon.",
  ...
  "Stremio addon, packaged into Bear's catalog.": "Addon do Stremio, incorporado ao catálogo do Bear.",
  ...
  "This order drives your catalog rows and the default stream order. A stream priority set in Settings overrides it for streams.": "Esta ordem controla suas faixas de catálogo e a ordem padrão dos streams. Uma prioridade de streams definida nas Configurações a substitui para streams.",
  ...
  "These live in Bear on this computer and never touch your account.": "Isso fica salvo no Bear deste computador e nunca toca na sua conta.",
  ...
  "Number 1 answers first when you press Play, unless Settings has a stream priority.": "O número 1 responde primeiro quando você aperta Play, a menos que as Configurações tenham uma prioridade de streams.",
  ...
  "Bear double-checks with Stremio after saving, so a half-written order can't slip through.": "O Bear confere novamente com o Stremio após salvar, para que uma ordem incompleta não passe despercebida.",
  "{n} addon": "{n} addon",
  "{n} addons": "{n} addons",
  ...
  "Saved, but Bear couldn't confirm the new order. Retry to re-check.": "Salvo, mas o Bear não conseguiu confirmar a nova ordem. Tente novamente para verificar.",
  "Stremio reports a different order than was saved.": "O Stremio reporta uma ordem diferente da que foi salva.",
  "A safety copy of your addon order. One is saved automatically before Bear writes any change, and you can save one yourself any time. The five most recent are kept.": "Uma cópia de segurança da sua ordem de complementos. Uma é salva automaticamente antes que o Bear grave qualquer alteração, e você também pode salvar uma a qualquer momento. As cinco mais recentes são mantidas.",
  ...
  "Click below to open {name}'s setup page in Bear's built-in browser. Pick your options. When you click Install on their page, Bear catches the link automatically and updates the addon.": "Clique abaixo para abrir a página de configuração de {name} no navegador integrado do Bear. Escolha suas opções. Ao clicar em Instalar na página deles, o Bear captura o link automaticamente e atualiza o addon.",
