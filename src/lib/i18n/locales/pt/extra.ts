const extra: Record<string, string> = {
  ...
  "{count} tracker request blocked this session. Bear itself sends zero telemetry.": "{count} solicitação de rastreador bloqueada nesta sessão. O próprio Bear não envia nenhuma telemetria.",
  "{d}d ago": "há {d}d",
  "{h}h ago": "há {h}h",
  ...
  "75\tThis instance of Bear is made for desktop. Our standalone iOS and Android apps are coming soon, each with a bespoke, mobile-first experience built for its native platform.": "75\tEsta instância do Bear é feita para desktop. Nossos aplicativos independentes para iOS e Android estão chegando em breve, cada um com uma experiência própria e feita para dispositivos móveis, construída para sua plataforma nativa.",
  ...
  "89\tTo run a public relay, post the {code} URL on r/Stremio or wherever your community lives. Other Bear users paste it into Settings, Bear Relay, {kbd}.": "89\tPara rodar um relay público, publique a URL de {code} no r/Stremio ou onde quer que sua comunidade esteja. Outros usuários do Bear podem colá-la em Configurações, Bear Relay, {kbd}.",
  ...
  "A browser tab opened on AniList. Approve Bear there, then copy the text it shows and paste it below.": "Uma aba do navegador foi aberta no AniList. Aprove o Bear lá, depois copie o texto exibido e cole abaixo.",
  "A browser tab opened on MyAnimeList. Approve Bear there, then copy the code or the page URL and paste it below.": "Uma aba do navegador foi aberta no MyAnimeList. Aprove o Bear lá, depois copie o código ou a URL da página e cole abaixo.",
  ...
  "Ad {n}": "Anúncio {n}",
  "Add": "Adicionar",
  "Add {n} titles from your Bear watchlist to Trakt? Trakt skips any it already has.": "Adicionar {n} títulos da sua watchlist do Bear ao Trakt? O Trakt ignora os que já tiver.",
  "Add {n} titles from your Trakt watchlist to Bear?": "Adicionar {n} títulos da sua watchlist do Trakt ao Bear?",
  ...
  "added": "adicionado",
  "Added {n} to your Bear watchlist": "Adicionado {n} à sua watchlist do Bear",
  ...
  "Authorize Bear on AniList": "Autorizar o Bear no AniList",
  "Authorize Bear on MyAnimeList": "Autorizar o Bear no MyAnimeList",
  "Authorize Bear on Simkl": "Autorizar o Bear no Simkl",
  "Authorize Bear on Trakt": "Autorizar o Bear no Trakt",
  ...
  "Calendar": "Calendário",
  "Canceled": "Cancelado",
  "Cap how much disk the cache can use. When it goes over, Bear deletes the oldest files first. Enforced on launch and as streams close.": "Limite quanto disco o cache pode usar. Quando ultrapassar, o Bear apaga primeiro os arquivos mais antigos. Aplicado na inicialização e quando os streams são encerrados.",
  "Catalog": "Catálogo",
  ...
  "Copy your Bear watchlist over to Trakt, or pull your Trakt watchlist into Bear. Safe to run again, Trakt skips anything it already has.": "Copie sua watchlist do Bear para o Trakt, ou importe sua watchlist do Trakt para o Bear. Pode executar novamente com segurança, o Trakt ignora o que já existe.",
  ...
  "Everyone who uses this Bear gets their own watch history, avatar, color, and optional PIN. Switch anytime.": "Cada pessoa que usa este Bear tem seu próprio histórico de exibição, avatar, cor e PIN opcional. Troque quando quiser.",
  ...
  "Bear keeps your MyAnimeList watch progress in sync.": "O Bear mantém seu progresso de visualização do MyAnimeList sincronizado.",
  "Bear ranking puts the best-scoring sources first. Addon order follows your addon priority (organize it in Addons, Installed tab, Reorder) and keeps each addon's results in the order it returned them, like the Stremio and Vidi apps.": "A classificação do Bear coloca as fontes com melhor pontuação primeiro. A ordem dos addons segue sua prioridade de addons (organize em Addons, aba Instalados, Reordenar) e mantém os resultados de cada addon na ordem em que foram retornados, como nos apps Stremio e Vidi.",
  "HDR": "HDR",
  ...
  "Hold Ctrl or Cmd and scroll to resize Bear's interface smoothly.": "Segure Ctrl ou Cmd e role para redimensionar a interface do Bear suavemente.",
  ...
  "Keeps HDR inside Bear with the controls floating above the video. Subtitles render on the video. If the control bar does not appear, press Esc or use separate window.": "Mantém o HDR dentro do Bear com os controles flutuando sobre o vídeo. As legendas são renderizadas sobre o vídeo. Se a barra de controles não aparecer, pressione Esc ou use janela separada.",
  ...
  "Options for the Library → Local tab: folders you scan from your own drive. When you export metadata, Bear writes a Kodi-style .nfo and downloads artwork next to each file at the sizes below.": "Opções para a aba Biblioteca → Local: pastas que você escaneia do seu próprio disco. Ao exportar metadados, o Bear grava um .nfo estilo Kodi e baixa artes ao lado de cada arquivo nos tamanhos abaixo.",
  ...
  "Pick a display and body pairing, or upload your own font to use across Bear.": "Escolha uma combinação de fonte de título e corpo de texto, ou envie sua própria fonte para usar em todo o Bear.",
  ...
  "Pick a source once and Bear keeps playing the rest of that season from the same release, no re-picking. Works best with a debrid season pack. Skipped for anime.": "Escolha uma fonte uma vez e o Bear continua reproduzindo o restante da temporada a partir do mesmo lançamento, sem precisar escolher de novo. Funciona melhor com um pacote de temporada via debrid. Ignorado para animes.",
  ...
  "Pick which audio and subtitle languages Bear reaches for first.": "Escolha quais idiomas de áudio e legenda o Bear prioriza primeiro.",
  ...
  "Playlist": "Playlist",
  "Plays + ratings sync from Bear to Trakt.tv.": "Reproduções e avaliações são sincronizadas do Bear para o Trakt.tv.",
  ...
  "Right-click any title in Bear or hit \\": "Clique com o botão direito em qualquer título no Bear ou pressione \\",
  ...
  "Set your MyAnimeList profile picture as your Bear avatar.": "Use a foto de perfil do seu MyAnimeList como seu avatar do Bear.",
  "Shadow": "Sombra",
  "Show": "Mostrar",
  ...
  "Show a Skip Intro / Skip Credits button when Bear detects one. Turn this off to never show it. You can also tap the X on the button to dismiss a wrong one for the rest of the episode.": "Mostra um botão Pular Abertura / Pular Créditos quando o Bear detecta um. Desative para nunca mostrar. Você também pode tocar no X do botão para dispensar um errado pelo resto do episódio.",
  ...
  "Show your operating system's own title bar with its minimize, maximize, and close buttons. They stay reachable everywhere, including while a video is playing. Turn this off to use Bear's built-in window buttons.": "Mostra a barra de título nativa do seu sistema operacional, com os botões de minimizar, maximizar e fechar. Eles ficam acessíveis em qualquer lugar, inclusive durante a reprodução de um vídeo. Desative para usar os botões de janela integrados do Bear.",
  ...
  "Sign in to Stremio first so Bear knows which watchlist to sync.": "Entre no Stremio primeiro para o Bear saber qual lista de interesse sincronizar.",
  ...
  "Skip the 'stream over peer-to-peer?' prompt and start uncached torrents immediately. Bear remembers your choice after the first confirmation anyway.": "Pular o aviso \"transmitir via peer-to-peer?\" e iniciar torrents não armazenados em cache imediatamente. De qualquer forma, o Bear lembra sua escolha após a primeira confirmação.",
  ...
  "Stream torrents straight from Bear's built-in engine when you have no debrid set up, or a torrent isn't cached. This connects to peers over your own connection. Turn off to only ever play debrid and direct links.": "Transmita torrents diretamente pelo mecanismo integrado do Bear quando você não tiver debrid configurado, ou quando um torrent não estiver em cache. Isso conecta a peers pela sua própria conexão. Desative para reproduzir apenas debrid e links diretos.",
  ...
  "This usually means antivirus removed the server file (stremio-server.exe). Add Bear's install folder to your antivirus exclusions, then reinstall.": "Isso geralmente significa que o antivírus removeu o arquivo do servidor (stremio-server.exe). Adicione a pasta de instalação do Bear às exclusões do seu antivírus e reinstale.",
  ...
  "Track everything you watch, see your watchlist, and get personalized recommendations on Bear's home page. Free at trakt.tv.": "Acompanhe tudo o que você assiste, veja sua watchlist e receba recomendações personalizadas na home do Bear. Gratuito em trakt.tv.",
  ...
  "When auto-playing the next episode, keep the same release/source you were just watching instead of Bear's top-ranked stream. Falls back to the best stream if that source isn't available.": "Ao reproduzir automaticamente o próximo episódio, manter o mesmo release/fonte que você estava assistindo em vez do stream mais bem classificado pelo Bear. Recorre ao melhor stream se essa fonte não estiver disponível.",
