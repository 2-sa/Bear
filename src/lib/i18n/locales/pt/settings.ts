...
"Sign in to Bear": "Iniciar sessão no Bear",
  ...
  "Home style (Bear curated / Classic Stremio)": "Estilo da página inicial (curadoria Bear / Stremio clássico)",
  ...
  "After you pick a source, show a subtitle picker so you can set the exact track and language before the video starts. Off by default, Bear keeps picking one for you automatically.": "Depois de escolher uma fonte, mostra um seletor de legendas para você definir a faixa e o idioma exatos antes de o vídeo começar. Desativado por padrão, o Bear continua escolhendo uma para você automaticamente.",
  "Aired": "Exibido",
  ...
  "Every format badge Bear can show on streams. Click one to swap its art, hide it, or reset it. Changes apply everywhere badges appear.": "Todos os selos de formato que o Bear pode exibir nos streams. Clique em um para trocar sua arte, ocultá-lo ou redefini-lo. As alterações se aplicam em todos os lugares onde os selos aparecem.",
  ...
  "MB": "MB",
  "Make Bear yours: swap the sidebar logo and the window/taskbar icon.": "Deixe o Bear com a sua cara: troque o logo da barra lateral e o ícone da janela/barra de tarefas.",
  ...
  "Native to Bear. No RPDB or ratings addon needed.": "Nativo do Bear. Sem necessidade de RPDB ou addon de avaliações.",
  ...
  "Pick a source once and Bear keeps playing the rest of that season from the same release, no re-picking. Works best with a debrid season pack. For anime it locks the whole series to that release.": "Escolha uma fonte uma vez e o Bear continua reproduzindo o resto daquela temporada a partir do mesmo lançamento, sem escolher de novo. Funciona melhor com um pacote de temporada em debrid. Para anime, trava a série inteira nesse lançamento.",
  ...
  "Serves this exact install of Bear as a web app on your network. Open it on a phone, laptop, or TV browser, sign in there, and it streams through this computer. You can also use the phone remote to control playback and cast to another device on this machine.": "Disponibiliza esta instalação exata do Bear como um app web na sua rede. Abra em um celular, notebook ou navegador de TV, faça login por lá, e ele transmite através deste computador. Você também pode usar o controle pelo celular para controlar a reprodução e transmitir para outro dispositivo nesta máquina.",
  ...
  "The resolution Bear downloads for each image when you export a title's metadata next to the file on disk.": "A resolução que o Bear baixa para cada imagem ao exportar os metadados de um título junto ao arquivo no disco.",
  ...
  "Use the arrow keys and Enter to move focus through Bear. Turn this off to keep arrow keys free and disable focus navigation everywhere.": "Use as teclas de seta e Enter para mover o foco pelo Bear. Desative isso para deixar as teclas de seta livres e desativar a navegação por foco em todos os lugares.",
  ...
  "Switch Bear to {language}?": "Mudar o Bear para {language}?",
  ...
  "Sets the language of Bear's own interface: menus, buttons, and labels. Arabic switches the layout to right to left. This is separate from subtitle and metadata languages below.": "Define o idioma da própria interface do Bear: menus, botões e rótulos. Árabe muda o layout para da direita para a esquerda. Isso é separado dos idiomas de legendas e metadados abaixo.",
  ...
  "Used for streaming availability and the Now Playing release window. Pick a country and Bear can match the interface, metadata, and subtitle languages to it.": "Usado para disponibilidade de streaming e a janela de lançamento do Em Reprodução. Escolha um país e o Bear pode ajustar a interface, os metadados e os idiomas de legenda de acordo.",
  "A free TMDB key is highly recommended. It unlocks the full Bear experience. The rest are optional, and Cinemeta works out of the box without any.": "Uma chave gratuita do TMDB é altamente recomendada. Ela desbloqueia toda a experiência do Bear. As demais são opcionais, e o Cinemeta funciona de imediato sem nenhuma delas.",
  ...
  "Bear still finds and loads subtitles so they're one click away in the player, it just won't turn them on automatically.": "O Bear continua encontrando e carregando legendas para que fiquem a um clique no player, só não as ativa automaticamente.",
  ...
  "When playback starts, Bear automatically finds and loads a subtitle in one of these languages, so you never have to search by hand. The first available match wins, so put your main language first.": "Quando a reprodução começa, o Bear encontra e carrega automaticamente uma legenda em um desses idiomas, para você nunca precisar buscar manualmente. A primeira correspondência disponível prevalece, então coloque seu idioma principal primeiro.",
  ...
  "When a release ships multiple audio tracks, Bear selects the first match from this list.": "Quando um release traz várias faixas de áudio, o Bear seleciona a primeira correspondência desta lista.",
  ...
  "When you back out of a title, Bear saves a frame so the Continue Watching card looks like the spot you left. Tune how long they stick around, or wipe them all.": "Quando você sai de um título, o Bear salva um quadro para que o card Continuar Assistindo mostre o ponto onde você parou. Ajuste por quanto tempo eles ficam ou apague todos.",
  ...
  "Heads up: Bear was built in English. Multi-language support is partial, so your addons usually catch what Bear's own filters miss. If you speak another language and want to help fill the gaps, the source is open.": "Atenção: o Bear foi criado em inglês. O suporte a múltiplos idiomas é parcial, então seus addons geralmente cobrem o que os filtros do próprio Bear deixam passar. Se você fala outro idioma e quer ajudar a preencher as lacunas, o código-fonte é aberto.",
  ...
  "How Bear finds and resolves playable streams. Debrid keys and addon installs live here.": "Como o Bear encontra e resolve streams reproduzíveis. As chaves de debrid e as instalações de addons ficam aqui.",
  "Languages": "Idiomas",
  ...
  "Every shortcut Bear responds to. Click a binding to rebind it.": "Todos os atalhos que o Bear reconhece. Clique em uma combinação para reatribuí-la.",
  "Theme & appearance": "Tema e aparência",
  "Color presets, custom backgrounds, and the font pair Bear renders in.": "Predefinições de cores, planos de fundo personalizados e o par de fontes com o qual o Bear é renderizado.",
  "Webhooks": "Webhooks",
  ...
  "Send a bug report straight to the Bear team. Screenshots and screen recordings welcome.": "Envie um relatório de bug diretamente para a equipe do Bear. Capturas de tela e gravações de tela são bem-vindas.",
  "Highly recommended. This is what gives you the full Bear experience: Popular, Trending, In Theaters, and per-service rails. Free at ": "Altamente recomendado. É isso que dá a você a experiência completa do Bear: Populares, Em Alta, Nos Cinemas e faixas por serviço. Grátis em ",
  ...
  "Watch Together rooms are routed through Bear's hosted relay.": "As salas do Assistir Juntos passam pelo relay hospedado do Bear.",
  "Streaming": "Streaming",
  "Playback": "Reprodução",
  ...
  "Help": "Ajuda",
  "العربية": "العربية",
  "When you back out of a title, Bear saves a frame so the Continue Watching card looks like the spot you left.": "Quando você sai de um título, o Bear salva um quadro para que o card de Continuar Assistindo mostre o ponto onde você parou.",
  ...
  "Bear checks harbor.site for new versions and installs them in place.": "O Bear verifica harbor.site em busca de novas versões e as instala no local.",
  "Backup & restore": "Backup e restauração",
  "Export your entire Bear setup to a single file, then restore it on a new computer or keep it as a backup.": "Exporte toda a sua configuração do Bear para um único arquivo, depois restaure em outro computador ou guarde como backup.",
  "Privacy": "Privacidade",
  "System tray": "Bandeja do sistema",
  "Stremio install links": "Links de instalação do Stremio",
  "Bear catches stremio:// install links so the configure-and-install flow stays inside the app.": "O Bear captura links de instalação stremio:// para que o fluxo de configurar e instalar permaneça dentro do app.",
  ...
  "Legal": "Legal",
  "Made with": "Feito com",
  "by Bear contributors": "pelos colaboradores do Bear",
  ...
  "Bear ranking": "Classificação do Bear",
  "Default. Bear parses and scores every source and surfaces the best quality first.": "Padrão. O Bear analisa e pontua cada fonte e mostra primeiro a melhor qualidade.",
  ...
  "Expired": "Expirado",
  "Bear pulls your addon collection from Stremio. Manage individual addons in Streaming sources.": "O Bear importa sua coleção de addons do Stremio. Gerencie addons individuais em Fontes de streaming.",
  ...
  "Ships with Bear. Always available.": "Vem incluído com o Bear. Sempre disponível.",
  ...
  "Classic. Was Bear's original pair.": "Clássico. Era o par original do Bear.",
  ...
  "Every variable, selector, hook, and recipe for building custom Bear themes.": "Todas as variáveis, seletores, hooks e receitas para criar temas personalizados do Bear.",
  ...
  "Use your operating system's native title bar and window buttons instead of Bear's built-in ones. Handy if the in-app buttons ever feel out of reach, like during playback.": "Use a barra de título e os botões de janela nativos do seu sistema operacional em vez dos integrados do Bear. Útil se os botões do app ficarem difíceis de alcançar, como durante a reprodução.",
  ...
  "Global": "Global",
  "Anywhere in Bear.": "Em qualquer lugar do Bear.",
  ...
  "Use my Simkl avatar as my Bear avatar": "Usar meu avatar do Simkl como avatar do Bear",
  ...
  "Send this to anyone you want to watch with. They paste it in their Settings → Bear Relay. After that, share a 6-character room code from the people icon up top.": "Envie isso para quem você quiser assistir junto. A pessoa cola em Configurações → Bear Relay. Depois, compartilhe um código de sala de 6 caracteres pelo ícone de pessoas no topo.",
  ...
  "Bear will scrobble your playback to Trakt and sync your watchlist.": "O Bear fará o scrobble da sua reprodução para o Trakt e sincronizará sua watchlist.",
  "Authorized": "Autorizado",
  "Open profile": "Abrir perfil",
  "Wear your Trakt profile picture across Bear instead of the default.": "Use sua foto de perfil do Trakt em todo o Bear em vez da padrão.",
  ...
  "Bear will mark what you finish as watched on Simkl and sync your plan-to-watch list.": "O Bear marcará o que você concluir como assistido no Simkl e sincronizará sua lista de planejo para assistir.",
  "Authorized on this device": "Autorizado neste dispositivo",
  "Wear your Simkl profile picture across Bear instead of the default.": "Use sua foto de perfil do Simkl em todo o Bear em vez da padrão.",
  ...
  "Bear shows your AniList lists on the Anime page and keeps your progress in sync.": "O Bear exibe suas listas do AniList na página de Anime e mantém seu progresso sincronizado.",
  ...
  "Show your AniList profile picture as your Bear avatar.": "Mostra sua foto de perfil do AniList como seu avatar no Bear.",
  ...
  "Discord posts a message to a channel whenever Bear pings it. Takes about a minute to set up.": "O Discord posta uma mensagem em um canal sempre que o Bear o notifica. Leva cerca de um minuto para configurar.",
  ...
  "Using AIOStreams or another aggregator addon? Its own sorting and filtering happen inside the addon before Bear ever sees the results, then Bear applies the stream filter and result order above on top. If results look thinner than expected, keep one side permissive: either relax the addon's internal filters or set Bear's stream filter to Balanced or Off.": "Está usando o AIOStreams ou outro addon agregador? A ordenação e a filtragem dele acontecem dentro do addon antes de o Bear ver os resultados, e depois o Bear aplica o filtro de streams e a ordem de resultados acima em cima disso. Se os resultados parecerem mais escassos que o esperado, mantenha um dos lados permissivo: relaxe os filtros internos do addon ou defina o filtro de streams do Bear como Equilibrado ou Desativado.",
  "Get yours at ": "Obtenha o seu em ",
  ". Used to check cache and unrestrict links. Bear never adds or removes torrents on its own.": ". Usado para verificar o cache e liberar links. O Bear nunca adiciona ou remove torrents por conta própria.",
  ...
  "Back": "Voltar",
  "Bear identity": "Identidade do Bear",
  ...
  "Bear finds intro and credits timing from AniSkip, TheIntroDB, and the file's own chapters, then shows a Skip button at the right moment.": "O Bear encontra os horários de abertura e créditos usando AniSkip, TheIntroDB e os próprios capítulos do arquivo, e então mostra um botão Pular no momento certo.",
  ...
  "2 min": "2 min",
  "Downloads": "Downloads",
  "Where Bear saves videos when you hit Download in the player. Pick any folder, including one on a different drive.": "Onde o Bear salva os vídeos quando você aperta Baixar no player. Escolha qualquer pasta, inclusive em outra unidade.",
  "HTML5": "HTML5",
  "mpv": "mpv",
  "Anime4K upscaling": "Upscaling Anime4K",
  "Flat_Style": "Flat_Style",
  "Background": "Plano de fundo",
  "{name} will be removed from Bear. Anything you've set to use it will fall back to Inter.": "{name} será removido do Bear. Tudo que você configurou para usá-lo voltará a usar o Inter.",
  ...
  "Power-user knob. Inject your own CSS, JS, and HTML into Bear. Lives in your local settings; nothing leaves your machine.": "Ajuste avançado. Injete seu próprio CSS, JS e HTML no Bear. Fica nas suas configurações locais; nada sai da sua máquina.",
  "You're modding your own client. Custom JS has full access to your Bear session. Only paste code you wrote or fully trust.": "Você está modificando seu próprio cliente. O JS personalizado tem acesso total à sua sessão do Bear. Cole apenas código que você mesmo escreveu ou em que confia totalmente.",
  ...
  "Bear's native player chrome.": "A interface nativa do player do Bear.",
  "Stremio": "Stremio",
  ...
  "Run your own Bear Relay": "Execute seu próprio Bear Relay",
  "Two paths: Bear handles the deploy for you, or you do it yourself with wrangler.": "Dois caminhos: o Bear cuida do deploy para você, ou você faz sozinho com o wrangler.",
  "Overview": "Sinopse",
  "The Bear relay is a Cloudflare Worker that hosts WebSocket rooms for Watch Together. Each user runs their own. There is no central Bear server.": "O relay do Bear é um Cloudflare Worker que hospeda salas WebSocket para o Assistir Juntos. Cada usuário executa o seu próprio. Não há um servidor central do Bear.",
  ...
  "Auto-deploy from Bear": "Implantar automaticamente pelo Bear",
  "Easiest path. Bear uploads the worker, creates the Durable Object namespace, and stores the resulting URL.": "Caminho mais fácil. O Bear envia o worker, cria o namespace do Durable Object e armazena a URL resultante.",
  "Open Settings, then Bear Relay.": "Abra Configurações e depois Bear Relay.",
  "Click {kbd}.": "Clique em {kbd}.",
  "Generate a Cloudflare API token with {code1} and {code2} permissions at {code3}. Paste it into Bear.": "Gere um token de API do Cloudflare com as permissões {code1} e {code2} em {code3}. Cole-o no Bear.",
  "Pick the Cloudflare account to deploy under.": "Escolha a conta do Cloudflare para fazer o deploy.",
  "Wait for the upload to finish. The relay URL gets written to {code} in Bear settings.": "Aguarde o envio terminar. A URL do relay é gravada em {code} nas configurações do Bear.",
  ...
  "Save the worker source. Copy {code1} from the Bear repo into a new directory as {code2}.": "Salve o código-fonte do worker. Copie {code1} do repositório do Bear para um novo diretório como {code2}.",
  ...
  "In Bear: Settings, Bear Relay, then {kbd}. Paste the URL with {code1} as the scheme instead of {code2}.": "No Bear: Configurações, Bear Relay, depois {kbd}. Cole a URL com {code1} como esquema em vez de {code2}.",
  "Verify it works": "Verificar se funciona",
  "Settings, Bear Relay, then {kbd}.": "Configurações, Bear Relay, depois {kbd}.",
  ...
  "To run a public relay, post the {code} URL on r/Stremio or wherever your community lives. Other Bear users paste it into Settings, Bear Relay, {kbd}.": "Para executar um relay público, publique a URL do {code} no r/Stremio ou onde sua comunidade estiver. Outros usuários do Bear colam em Configurações, Bear Relay, {kbd}.",
  "Costs": "Custos",
  ...
  "Get started": "Começar",
  "Cloudflare token form filled with name 'Bear Relay' and one permission row set to Account / Workers Scripts / Edit": "Formulário de token do Cloudflare preenchido com o nome 'Bear Relay' e uma linha de permissão definida como Account / Workers Scripts / Edit",
  ...
  "Save the current frame (video only, no subtitles) as a PNG to Pictures/Bear.": "Salvar o quadro atual (somente vídeo, sem legendas) como PNG em Pictures/Bear.",
  "Record GIF": "Gravar GIF",
  "Start or stop recording a GIF of the video (no subtitles). Saves to Pictures/Bear.": "Iniciar ou parar a gravação de um GIF do vídeo (sem legendas). Salva em Imagens/Bear.",
  ...
  "Bear is open source. PRs that reference a bug get reviewed within 48h and ship with credit in the release notes.": "O Bear é open source. PRs que referenciam um bug são revisados em até 48h e publicados com crédito nas notas de versão.",
  ...
  "Bear test message (Discord). If you can read this, your webhook is wired up.": "Mensagem de teste do Bear (Discord). Se você consegue ler isto, seu webhook está configurado corretamente.",
  "Bear test message (Telegram). If you can read this, your webhook is wired up.": "Mensagem de teste do Bear (Telegram). Se você consegue ler isto, seu webhook está configurado corretamente.",
  "Failed": "Falhou",
  "Types": "Tipos",
  "Movies": "Filmes",
  "TV": "TV",
  ...
  "name it Bear, hit": "nomeie-o como Bear, clique em",
  ...
  "and your": "e o seu",
  "Both go in the boxes above. Bear builds the URL for you.": "Ambos vão nos campos acima. O Bear monta a URL para você.",
  "Tap": "Toque",
  ...
  "Heads up": "Aviso",
  "Bear scans your IPTV playlists' EPG every 30 min for programs about to start.": "O Bear verifica o EPG das suas playlists IPTV a cada 30 min em busca de programas prestes a começar.",
  ...
  "Bear checks harbor.site for new versions and installs them in place. Nothing installs until you choose to, and a dismissed update never nags you again.": "O Bear verifica o harbor.site em busca de novas versões e as instala no local. Nada é instalado até você decidir, e uma atualização dispensada nunca mais incomoda.",
  ...
  "Export your entire Bear setup to a single file, then restore it on a new computer or keep it as a backup. Everything is included except your Stremio sign-in.": "Exporte toda a configuração do seu Bear para um único arquivo e restaure em outro computador ou mantenha como backup. Tudo é incluído, exceto seu login do Stremio.",
  "Bear sends no telemetry. This also drops outbound ad, analytics, and tracker requests that addons or metadata providers try to make, before they leave your machine.": "O Bear não envia telemetria. Isso também bloqueia requisições de anúncios, análises e rastreadores que addons ou provedores de metadados tentam fazer, antes que saiam da sua máquina.",
  "Keep Bear a click away. Close it to the system tray instead of quitting, and control it from the tray menu. These also mirror into the tray menu live.": "Mantenha o Bear a um clique de distância. Feche-o na bandeja do sistema em vez de encerrá-lo, e controle-o pelo menu da bandeja. Isso também reflete no menu da bandeja em tempo real.",
  "Your color": "Sua cor",
  ...
  "Bear catches stremio:// install links so the configure-and-install flow stays inside the app. Every install also syncs to your Stremio account, so the official app remains the canonical home for your library.": "O Bear intercepta links de instalação stremio:// para que o fluxo de configurar e instalar permaneça dentro do app. Toda instalação também sincroniza com sua conta Stremio, então o app oficial continua sendo a fonte principal da sua biblioteca.",
  "Let your Discord friends see what you are watching, with the show poster and a live progress bar. Desktop only, and only your own Discord client is involved (nothing touches a Bear server).": "Deixe seus amigos do Discord verem o que você está assistindo, com o pôster da série e uma barra de progresso ao vivo. Apenas no desktop, e só o seu próprio cliente do Discord é envolvido (nada passa por um servidor do Bear).",
  "Saved {d} from Bear {a}.": "Salvo {d} do Bear {a}.",
  ...
  "Hitting Play jumps straight into playback with the best stream Bear finds.": "Ao pressionar Reproduzir, você entra direto na reprodução com o melhor stream que o Bear encontrar.",
  ...
  "Bundled with Bear. Plays anything you throw at it.": "Incluído no Bear. Reproduz qualquer coisa que você jogar nele.",
  "Embed mpv inside Bear window": "Incorporar o mpv na janela do Bear",
  "Renders mpv inline so playback lives in Bear itself. Disable to open it in a separate window instead.": "Renderiza o mpv de forma integrada para que a reprodução aconteça dentro do próprio Bear. Desative para abri-lo em uma janela separada.",
  ...
  "Use Bear's built-in engine (beta)": "Usar o mecanismo integrado do Bear (beta)",
  "Stream torrents through Bear's own Rust peer-to-peer engine instead of the bundled Stremio Server. Falls back automatically if it can't connect. Status and a self-test live in the Local engine card below.": "Transmita torrents pelo próprio mecanismo peer-to-peer em Rust do Bear, em vez do Stremio Server incluso. Retorna automaticamente ao padrão se não conseguir conectar. O status e um autoteste estão no card do Mecanismo local abaixo.",
  ...
  "will be removed from Bear. Anything you've set to use it will fall back to Inter.": "será removido do Bear. Tudo que você configurou para usá-la voltará a usar Inter.",
  ...
  "Server reachable in {ms}ms. Bear will use it for torrent streaming.": "Servidor acessível em {ms}ms. O Bear vai usá-lo para streaming de torrent.",
  ...
  "Bear curated": "Curadoria do Bear",
  ...
  "{n} tracker request blocked this session. Bear itself sends zero telemetry.": "{n} solicitação de rastreador bloqueada nesta sessão. O próprio Bear não envia nenhuma telemetria.",
  "{n} tracker requests blocked this session. Bear itself sends zero telemetry.": "{n} solicitações de rastreador bloqueadas nesta sessão. O próprio Bear não envia nenhuma telemetria.",
  "Watching for ad, analytics, and tracking requests. Bear itself sends zero telemetry.": "Monitorando requisições de anúncios, análise e rastreamento. O próprio Bear não envia nenhuma telemetria.",
  ...
  "Closing the window tucks Bear into the tray instead of quitting, so it reopens instantly. Right-click the tray icon for quick controls, or pick Quit to exit fully.": "Fechar a janela envia o Bear para a bandeja em vez de sair, para que reabra instantaneamente. Clique com o botão direito no ícone da bandeja para controles rápidos, ou escolha Sair para encerrar completamente.",
  "Always on top": "Sempre no topo",
  "Keep the Bear window above other windows.": "Manter a janela do Bear acima de outras janelas.",
  "Pause when minimized": "Pausar ao minimizar",
  "Stop playback when you minimize Bear or send it to the tray.": "Parar a reprodução ao minimizar o Bear ou enviá-lo para a bandeja.",
  ...
  "Saves your whole Bear setup to one file: theme, home layout, settings, addons, profiles, watchlist, player layouts, watch progress, and more. Your Stremio sign-in is left out on purpose.": "Salva toda a sua configuração do Bear em um único arquivo: tema, layout da tela inicial, configurações, addons, perfis, lista de interesse, layouts do player, progresso de reprodução e mais. Seu login do Stremio é deixado de fora propositalmente.",
  ...
  "This replaces your current Bear setup (theme, home layout, settings, addons, profiles, and more) with the {n} saved entries in this file. Your Stremio sign-in stays as is. Bear reloads when it finishes.": "Isso substitui sua configuração atual do Bear (tema, layout da home, configurações, addons, perfis e mais) pelas {n} entradas salvas neste arquivo. Seu login do Stremio permanece o mesmo. O Bear recarrega ao terminar.",
  ...
  "Bear's in-app installer animates the manifest install and keeps you in context. Anything Bear installs is also synced to your Stremio account, so the official app stays the canonical library. Turn this off and Stremio becomes the only handler for stremio:// links; Bear still installs anything you trigger from inside the app (Configure & install, paste, drag-and-drop).": "O instalador integrado do Bear anima a instalação do manifesto e mantém você no contexto. Tudo que o Bear instala também é sincronizado com sua conta Stremio, então o app oficial continua sendo a biblioteca principal. Desative isso e o Stremio se torna o único responsável pelos links stremio://; o Bear ainda instala tudo que você acionar dentro do app (Configurar e instalar, colar, arrastar e soltar).",
  "Heads up: if Stremio is also installed, Windows may ask which app to use the first time a stremio:// link fires. Pick Bear to make it stick.": "Atenção: se o Stremio também estiver instalado, o Windows pode perguntar qual app usar na primeira vez que um link stremio:// for acionado. Escolha o Bear para fixar a escolha.",
  "stremio:// links now open in the Stremio app. Bear will only install when you trigger it from inside Bear.": "links stremio:// agora abrem no app Stremio. O Bear só instalará quando você acioná-lo de dentro do Bear.",
  ...
  "Installing. Bear will restart.": "Instalando. O Bear será reiniciado.",
  ...
  "Bear checks automatically every few hours.": "O Bear verifica automaticamente a cada algumas horas.",
  "Bear {version} available": "Bear {version} disponível",
  ...
  "Display 'Browsing Bear' when nothing is playing.": "Exibir 'Navegando no Bear' quando nada estiver em reprodução.",
  ...
  "Rewrites every library item to match Stremio's exact schema. Run once if your Stremio app started crashing after Bear synced playback.": "Reescreve cada item da biblioteca para corresponder exatamente ao esquema do Stremio. Execute uma vez se o seu app Stremio começou a travar depois que o Bear sincronizou a reprodução.",
  ...
  "Everything you save here stays in this browser. Your Stremio login, API keys, watch progress, picker cache, dismissed tips. Bear servers never see any of it. Clearing your browser data wipes it.": "Tudo o que você salva aqui fica neste navegador. Seu login do Stremio, chaves de API, progresso de exibição, cache do seletor, dicas dispensadas. Os servidores do Bear nunca veem nada disso. Limpar os dados do navegador apaga tudo.",
  ...
  "Get Bear for desktop": "Obtenha o Bear para computador",
  ...
  "Bear's public relay updates automatically; nothing to do.": "O relay público do Bear atualiza automaticamente; nada a fazer.",
  ...
  "Cloudflare shows API tokens only once. Save a copy now or you'll lose the ability to stop or redeploy this relay from Bear.": "O Cloudflare exibe os tokens de API apenas uma vez. Salve uma cópia agora ou você perderá a capacidade de parar ou reimplantar este relay pelo Bear.",
  ...
  "Hit your daily quota? Use Bear's public relay, or host your own.": "Atingiu sua cota diária? Use o relay público do Bear ou hospede o seu próprio.",
  "Use Bear's public relay": "Usar o relay público do Bear",
  ...
  "Connect Discord or Telegram and Bear posts a message when something you follow is about to drop. Hit Test to send yourself a sample first.": "Conecte o Discord ou o Telegram e o Bear publica uma mensagem quando algo que você segue está prestes a ser lançado. Clique em Testar para enviar uma amostra para você mesmo primeiro.",
  ...
  "Real-time GPU upscaling that sharpens lines and cleans up gradients on anime, built right into Bear's player. The one-tap setup below grabs the shaders; nothing else to install.": "Upscaling por GPU em tempo real que aprimora linhas e limpa gradientes em animes, integrado diretamente ao player do Bear. A configuração de um toque abaixo baixa os shaders; nada mais para instalar.",
  ...
  "Bear's built-in frame interpolation. Smooths panning, best on anime. Needs a display refresh rate above the video's frame rate, and can stutter on weak GPUs. Lighter than SVP.": "A interpolação de quadros integrada do Bear. Suaviza panorâmicas, funciona melhor em animes. Precisa de uma taxa de atualização da tela acima da taxa de quadros do vídeo, e pode engasgar em GPUs fracas. Mais leve que o SVP.",
  "SVP frame interpolation": "Interpolação de quadros do SVP",
  "Genuine 48/60fps motion on anime, rendered right inside Bear's player. SVP supplies the engine (VapourSynth + svpflow) and runs in your tray for licensing; Bear's own player applies the interpolation, so it stays embedded and fully under your control. One-time install, then flip it on.": "Movimento genuíno de 48/60fps em animes, renderizado diretamente dentro do player do Bear. O SVP fornece o motor (VapourSynth + svpflow) e roda na bandeja do sistema para licenciamento; o próprio player do Bear aplica a interpolação, então tudo fica embutido e sob seu controle total. Instalação única, depois é só ativar.",
  "SVP (free)": "SVP (grátis)",
  "Install SVP once (the free tier is enough). It bundles VapourSynth + svpflow; Bear reuses them, no extra setup.": "Instale o SVP uma vez (o nível gratuito é suficiente). Ele inclui VapourSynth + svpflow; o Bear os reutiliza, sem configuração extra.",
  "Installed and detected. Bear found its interpolation engine and will drive it directly.": "Instalado e detectado. O Bear encontrou seu mecanismo de interpolação e o controlará diretamente.",
  "SVP is installed but Bear couldn't find its engine files (svpflow + VapourSynth). Try repairing the SVP install, or reopen SVP once.": "O SVP está instalado, mas o Bear não encontrou os arquivos do mecanismo (svpflow + VapourSynth). Tente reparar a instalação do SVP ou reabra o SVP uma vez.",
  "Get SVP (free)": "Obtenha o SVP (grátis)",
  "Open SVP": "Abrir SVP",
  "Enable SVP": "Ativar SVP",
  "Bear's player applies the interpolation itself, embedded like normal playback, and starts SVP Manager in the tray for licensing. Restart playback to apply. If video goes black or won't start, turn this off.": "O player do Bear aplica a interpolação diretamente, incorporada como uma reprodução normal, e inicia o SVP Manager na bandeja para licenciamento. Reinicie a reprodução para aplicar. Se o vídeo ficar preto ou não iniciar, desative isso.",
  "Finish the install above first. Flipping this on now won't do anything until Bear can find SVP's engine.": "Termine a instalação acima primeiro. Ativar isso agora não vai fazer nada até o Bear conseguir encontrar o motor do SVP.",
  ...
  "Anime4K and smooth-motion run on the bundled mpv engine in the Bear desktop app. They have no effect in the browser.": "Anime4K e suavização de movimento rodam no engine mpv incluso no app desktop do Bear. Não têm efeito no navegador.",
  ...
  "Bear uses the graphics card when it's safe and falls back to the CPU when it isn't. The right call for almost everyone.": "O Bear usa a placa de vídeo quando é seguro e recorre à CPU quando não é. A escolha certa para quase todo mundo.",
  ...
  "If video keeps pausing to buffer, or you're on spotty Wi-Fi or a far-away server, this gives Bear a bigger head start so playback rides through the rough patches.": "Se o vídeo continuar pausando para carregar, ou você estiver em um Wi-Fi instável ou servidor distante, isso dá ao Bear uma folga maior para a reprodução aguentar os trechos difíceis.",
  ...
  "These tune the bundled mpv engine, which runs in the Bear desktop app. They have no effect in the browser.": "Isso ajusta o mecanismo mpv incluído, que roda no app desktop do Bear. Não tem efeito no navegador.",
  ...
  "In Bear: Settings, Bear Relay, then": "No Bear: Configurações, Bear Relay, depois",
  "Paste the URL with": "Cole a URL com",
  "as the scheme instead of": "como o esquema em vez de",
  "Settings, Bear Relay, then": "Configurações, Bear Relay, depois",
  ...
  "URL on r/Stremio or wherever your community lives. Other Bear users paste it into Settings, Bear Relay,": "URL no r/Stremio ou onde quer que sua comunidade esteja. Outros usuários do Bear colam em Configurações, Bear Relay,",
  ...
  "You must install this addon in your Stremio account first so Bear can fetch its works.": "Você deve instalar esta extensão na sua conta do Stremio primeiro para que o Bear possa buscar seus conteúdos.",
  ...
  "OK": "OK",
  "Loading...": "Carregando...",
  "Bring your Letterboxd watchlist, diary, liked films and lists into Bear via the Stremboxd bridge.": "Traga sua watchlist, diário, filmes curtidos e listas do Letterboxd para o Bear via a ponte Stremboxd.",
  ...
  "Full mode signs in with your Letterboxd password to also unlock your diary, friends activity and your personal ratings. Your password is sent only to Stremboxd to obtain a token — Bear never stores it.": "O modo completo faz login com sua senha do Letterboxd para também desbloquear seu diário, atividade de amigos e suas avaliações pessoais. Sua senha é enviada apenas ao Stremboxd para obter um token — o Bear nunca a armazena.",
