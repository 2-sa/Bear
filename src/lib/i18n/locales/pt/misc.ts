const misc: Record<string, string> = {
  ...
  "Does Bear {version} feel better or worse than the version you had before?": "O Bear {version} parece melhor ou pior do que a versão que você tinha antes?",
  ...
  "Bear couldn't resolve a usable ID for this title. Add a TMDB key in Library settings or sign in to Stremio to broaden coverage.": "O Bear não conseguiu resolver um ID utilizável para este título. Adicione uma chave TMDB nas configurações da Biblioteca ou entre no Stremio para ampliar a cobertura.",
  ...
  "On the web, Bear can only reach addons that allow browser access (Torrentio, TorBox, Cinemeta). For unreleased titles, no source typically exists yet.": "Na web, o Bear só consegue acessar addons que permitem acesso pelo navegador (Torrentio, TorBox, Cinemeta). Para títulos ainda não lançados, geralmente nenhuma fonte existe ainda.",
  "Try signing in to Stremio so Bear can use your addon collection. Older or foreign titles often need Torrentio + a debrid addon to find anything.": "Tente entrar no Stremio para que o Bear possa usar sua coleção de addons. Títulos antigos ou estrangeiros geralmente precisam do Torrentio + um addon debrid para encontrar algo.",
  ...
  "update.restartAuto": "O Bear será reiniciado automaticamente.",
  "update.tryAgain": "Tentar novamente",
  "update.keepUsing": "Continue usando o Bear durante o download",
  ...
  "Anything you install in Bear pushes back to your Stremio account so it shows up on mobile too. Sign in via the avatar in the bottom-left of the sidebar.": "Tudo que você instala no Bear é enviado de volta para sua conta Stremio, para aparecer no celular também. Entre pelo avatar no canto inferior esquerdo da barra lateral.",
  "Starters": "Iniciais",
  ...
  "Trending tracks star growth across your Bear visits. Open the addons page again tomorrow and the top risers will appear here.": "O Em Alta acompanha o crescimento de popularidade nas suas visitas ao Bear. Abra a página de addons novamente amanhã e os que mais subiram aparecerão aqui.",
  ...
  "'s setup page in Bear's built-in browser. Pick your options. When you click Install on their page, Bear catches the link automatically and updates the addon.": "a página de configuração deles no navegador integrado do Bear. Escolha suas opções. Quando você clicar em Install na página deles, o Bear captura o link automaticamente e atualiza o addon.",
  ...
  "Add a TMDB key for the full Bear": "Adicione uma chave do TMDB para o Bear completo",
  ...
  "This instance of Bear is made for desktop. Our standalone iOS and Android apps are coming soon, each with a bespoke, mobile-first experience built for its native platform.": "Esta instância do Bear foi feita para desktop. Nossos aplicativos independentes para iOS e Android estão chegando em breve, cada um com uma experiência sob medida, pensada primeiro para dispositivos móveis e construída para sua plataforma nativa.",
  "For now, please open this site on a desktop, or build Bear from source.": "Por enquanto, abra este site em um computador ou compile o Bear a partir do código-fonte.",
  ...
  "Continue Watching, then your addon catalogs in install order. No hero, no Bear rails.": "Continuar Assistindo, depois os catálogos dos seus addons na ordem de instalação. Sem destaque, sem faixas do Bear.",
  ...
  "Skip if you'd rather just use Cinemeta. Bear still works, you'll just see fewer rails.": "Pule se preferir usar só o Cinemeta. O Bear continua funcionando, você só verá menos categorias.",
  ...
  "Sign in to mirror your Continue Watching, watchlist, and any addons you've already curated. Optional; Bear works fully signed-out.": "Entre para espelhar seu Continuar Assistindo, sua watchlist e quaisquer addons que você já tenha organizado. Opcional; o Bear funciona totalmente sem login.",
  ...
  "Bear pulls the most popular titles each service has right now. Toggle off anything you don't subscribe to.": "O Bear busca os títulos mais populares que cada serviço tem no momento. Desative qualquer serviço ao qual você não seja assinante.",
  ...
  "When playback starts, Bear finds and loads a subtitle in one of these languages automatically. The first available match wins, so put your main language first.": "Quando a reprodução começa, o Bear encontra e carrega automaticamente uma legenda em um desses idiomas. A primeira correspondência disponível vence, então coloque seu idioma principal primeiro.",
