const live: Record<string, string> = {
  ...
  "Venue": "Local",
  "Start": "Início",
  "This match has not started yet.": "Esta partida ainda não começou.",
  "Scores will appear here once play begins.": "Os placares aparecerão aqui quando o jogo começar.",
  "Recently finished": "Encerrados recentemente",
  "Tennis tournaments": "Torneios de tênis",
  "Tournaments": "Torneios",
  "Underway": "Em andamento",
  "Grand Slam": "Grand Slam",
  "SLAM": "SLAM",
  "No tournaments found right now.": "Nenhum torneio encontrado no momento.",
  "The draw is not published yet.": "A chave ainda não foi publicada.",
  "Defending champion": "Campeão anterior",
  ...
  "Bear caps playlists at 80 MB to stay responsive. Most providers offer a filtered URL with fewer channels.": "O Bear limita playlists a 80 MB para manter a fluidez. A maioria dos provedores oferece uma URL filtrada com menos canais.",
