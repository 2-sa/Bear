const sync: Record<string, string> = {
  ...
  "Bear's public relay has not rolled out the latest protocol yet.": "O relay público do Bear ainda não implantou o protocolo mais recente.",
  ...
  "Redeploy it to get the latest Watch Together fixes. Bear's public relay updates on its own.": "Reimplante para obter as últimas correções do Watch Together. O relay público do Bear se atualiza sozinho.",
  ...
  "Show your AniList lists as rails on the Anime page, keep your watch progress in sync as you finish episodes, and use your AniList avatar as your Bear photo. Free at anilist.co.": "Mostra suas listas do AniList como trilhas na página de Anime, mantém seu progresso de exibição sincronizado ao terminar episódios, e usa seu avatar do AniList como sua foto no Bear. Gratuito em anilist.co.",
  ...
  "Sync and track movies, shows, and anime across everything you use. Bear marks what you finish as watched on Simkl and keeps your plan-to-watch list in step. Free at simkl.com.": "Sincronize e acompanhe filmes, séries e animes em tudo o que você usa. O Bear marca o que você termina como assistido no Simkl e mantém sua lista de planos para assistir em dia. Gratuito em simkl.com.",
