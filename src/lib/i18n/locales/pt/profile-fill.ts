const profileFill: Record<string, string> = {
  ...
  "Ratings need a Bear account": "As avaliações exigem uma conta Bear",
  "Your Bear account is separate from your Stremio sign in. Create one free or sign in from Settings.": "A sua conta Bear é separada do seu início de sessão no Stremio. Crie uma gratuitamente ou inicie sessão nas Definições.",
  ...
  "Couldn't reach Bear, check your connection": "Não foi possível conectar ao Bear, verifique sua conexão",
  "Bear is having trouble, try again in a moment": "O Bear está com problemas, tente novamente em um momento",
  "Ratings": "Avaliações",
  ...
  "Something went wrong reaching Bear. Check your connection and try again.": "Algo deu errado ao conectar ao Bear. Verifique sua conexão e tente novamente.",
