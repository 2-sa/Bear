const profileFill: Record<string, string> = {
  ...
  "Ratings need a Bear account": "Для оценок нужен аккаунт Bear",
  "Your Bear account is separate from your Stremio sign in. Create one free or sign in from Settings.": "Аккаунт Bear не связан с входом в Stremio. Создайте его бесплатно или войдите в настройках.",
