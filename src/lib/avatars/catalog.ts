...
const SOURCE_AVATAR_CATALOG: AvatarGroup[] = [
  {
    group: "South Park",
    items: [
...
const ALL_AVATARS = SOURCE_AVATAR_CATALOG.flatMap((group) => group.items).sort((a, b) =>
  a.name.localeCompare(b.name),
);
const AVATAR_SECTIONS = [
  { group: "A–C", pattern: /^[A-C]/i },
  { group: "D–F", pattern: /^[D-F]/i },
  { group: "G–I", pattern: /^[G-I]/i },
  { group: "J–L", pattern: /^[J-L]/i },
  { group: "M–O", pattern: /^[M-O]/i },
  { group: "P–R", pattern: /^[P-R]/i },
  { group: "S–U", pattern: /^[S-U]/i },
  { group: "V–X", pattern: /^[V-X]/i },
  { group: "Y–Z", pattern: /^[Y-Z]/i },
];

export const AVATAR_CATALOG: AvatarGroup[] = AVATAR_SECTIONS.map(({ group, pattern }) => ({
  group,
  items: ALL_AVATARS.filter((item) => pattern.test(item.name)),
