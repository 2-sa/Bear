...
export const THEME_PRESETS: Record<ThemePresetId, ThemePreset> = {
  ...
  "tokyo-night": {
    ...
    swatch: ["#111821", "#232e40", "#f08032"],
    tokens: {
      "--color-canvas": "#111821",
      "--color-surface": "#192331",
      "--color-elevated": "#232e40",
      "--color-raised": "#303d52",
      "--color-ink": "#f5f6fa",
...
/* ==========================================================================
   ElegantFin for Bear  (after lscambo13's ElegantFin Jellyfin theme)
...
/* Retoken Bear's @theme palette to Feishin's near-black ladder + electric blue */
:root {
  --color-canvas: #0C0C0C;
...
/* Hide Bear's floating-back + retint window controls (rail carries nav) */
...
export const FONT_PAIRS: Record<FontPairId, FontPair> = {
  ...
  "fraunces-inter": {
    id: "fraunces-inter",
    name: "Fraunces + Inter",
    blurb: "Classic. Was Bear's original pair.",
