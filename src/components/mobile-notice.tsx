    ...
    <div className="flex min-h-dvh flex-col items-center justify-center gap-7 bg-canvas px-8 text-center">
      ...
      <div className="flex max-w-md flex-col gap-3.5">
        ...
        <p className="text-[14.5px] leading-relaxed text-ink-muted">
          {t(
            "This instance of Bear is made for desktop. Our standalone iOS and Android apps are coming soon, each with a bespoke, mobile-first experience built for its native platform.",
          )}
        </p>
        <p className="text-[14.5px] leading-relaxed text-ink-muted">
          {t("For now, please open this site on a desktop, or build Bear from source.")}
        </p>
      </div>
      <a
        href="https://github.com/2-sa/Bear"
        target="_blank"
        rel="noreferrer"
