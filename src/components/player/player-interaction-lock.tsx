    ...
    >
      {locked ? (
        <button
          ...
          aria-label={`Unlock player controls (${formatBindingForDisplay(binding)})`}
        >
        ...
        <button
          ...
          aria-label={`Lock player controls (${formatBindingForDisplay(binding)})`}
          title={`Lock controls · ${formatBindingForDisplay(binding)}`}
        >
