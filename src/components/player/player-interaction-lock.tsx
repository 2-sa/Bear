    ...
    >
      {locked && visible ? (
        <button
          ...
          aria-label={`${t("Unlock player controls")} (${formatBindingForDisplay(binding)})`}
        >
        ...
        <button
          ...
          aria-label={`${t("Lock player controls")} (${formatBindingForDisplay(binding)})`}
          title={`${t("Lock controls")} · ${formatBindingForDisplay(binding)}`}
        >
