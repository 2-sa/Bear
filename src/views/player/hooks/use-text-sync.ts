...
async function writeSubtitleFile(
  ...
  try {
    ...
    const directory = persistent ? "bear-beta-subs-saved" : "bear-beta-subs-preview";
    return await writeTempTextFile(directory, fileName, text, { persistent });
  } catch {
    return null;
  }
}
