  ...
  return (
    <>
      {addonsSettled && (!streamIds || streamIds.length === 0) && (
        <EmptyState
          message="Bear couldn't resolve a usable ID for this title. Add a TMDB key in Library settings or sign in to Stremio to broaden coverage."
          ...
          <div className="flex min-w-0 flex-1 flex-col">
            ...
            <p className="text-[12.5px] leading-snug text-ink-muted">
              ...
              {rawCount - allCount > 0 && !forceShowAll
                ? ` Bear dropped ${rawCount - allCount} suspicious or mismatched result${rawCount - allCount === 1 ? "" : "s"}.`
                : ""}
            </p>
          </div>
          {rawCount - allCount > 0 && !forceShowAll && (
