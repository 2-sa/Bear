    ...
    >
      ...
      <p className="ps-7 text-[12.5px] leading-relaxed text-ink-muted">
        {isWeb()
          ...
          : t("Click below to open {name}'s setup page in Bear's built-in browser. Pick your options. When you click Install on their page, Bear catches the link automatically and updates the addon.", { name })}
      </p>
      <button
        type="button"
        onClick={onOpenSetup}
