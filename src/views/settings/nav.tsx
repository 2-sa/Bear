...
const SETTINGS_OPTIONS: SettingsOption[] = [
  ...
  { label: "Bear on other devices (web app)", section: "remotes", anchorTitle: "Bear on other devices", keywords: ["harbor in browser", "web ui", "web app", "web version", "11472", "serve", "network", "tv browser", "laptop", "open on phone"] },
  ...
  { label: "Watch Together relay", section: "relay", anchorTitle: "Bear Relay", keywords: ["watch together", "relay", "party", "p2p", "host", "cloudflare", "deploy", "share"] },
  ...
  { label: "Bear identity (avatar / color)", section: "account", anchorTitle: "Bear identity", keywords: ["avatar", "profile photo", "upload photo", "color", "identity", "picture"] },
  ...
  { label: "Bear identity", section: "account", anchorTitle: "Bear identity", keywords: ["display name", "nickname", "rename", "edit name", "watch together name", "identity", "profile"] },
  { label: "Upload photo", section: "account", anchorTitle: "Bear identity", keywords: ["avatar", "upload", "profile picture", "custom photo", "image", "change avatar"] },
  { label: "or use one of our avatars", section: "account", anchorTitle: "Bear identity", keywords: ["avatar catalog", "built-in avatars", "browse avatars", "picker", "characters", "netflix style"] },
  { label: "Random avatar", section: "account", anchorTitle: "Bear identity", keywords: ["random", "shuffle", "surprise avatar", "dice"] },
  { label: "Reset to Stremio avatar", section: "account", anchorTitle: "Bear identity", keywords: ["reset avatar", "default avatar", "remove photo", "revert", "reset to default"] },
  { label: "Your color", section: "account", anchorTitle: "Bear identity", keywords: ["color", "cursor color", "chat color", "name pill", "custom color", "hex picker", "swatch"] },
  { label: "Profiles (switch, add, edit)", section: "account", anchorTitle: "Bear identity", keywords: ["profiles", "profile", "who's watching", "whos watching", "who is watching", "switch profile", "add profile", "new profile", "edit profile", "manage profiles", "default profile", "kids profile", "child profile", "multiple profiles", "profile screen", "startup profile", "household"] },
  ...
  { label: "Use my Trakt avatar as my Bear avatar", section: "trakt", keywords: ["trakt avatar", "profile picture", "avatar sync", "wear avatar"] },
  ...
  { label: "Use my AniList avatar as my Bear avatar", section: "anilist", keywords: ["anilist avatar", "profile picture", "avatar", "wear avatar"] },
  ...
  { label: "Use my Simkl avatar as my Bear avatar", section: "simkl", keywords: ["simkl avatar", "profile picture", "avatar", "wear avatar"] },
  ...
  { label: "Bear Relay", section: "relay", anchorTitle: "Bear Relay", keywords: ["relay", "watch together", "cloudflare worker", "rooms", "sync server", "copy url", "hosted relay"] },
  { label: "Deploy a relay", section: "relay", anchorTitle: "Bear Relay", keywords: ["deploy", "cloudflare", "worker", "self host", "setup relay", "desktop only"] },
  { label: "Use Bear's public relay", section: "relay", anchorTitle: "Bear Relay", keywords: ["public relay", "hosted relay", "default relay", "quota", "pub relay"] },
  { label: "Enter an existing relay URL:", section: "relay", anchorTitle: "Bear Relay", keywords: ["relay url", "wss", "workers.dev", "custom relay", "paste url", "save"] },
  { label: "Test relay connection", section: "relay", anchorTitle: "Bear Relay", keywords: ["test connection", "run test", "ping", "health", "reachable", "verify relay"] },
  { label: "Backup credentials", section: "relay", anchorTitle: "Bear Relay", keywords: ["export", "backup", "api token", "credentials", "json file", "cloudflare token"] },
  { label: "Stop relay", section: "relay", anchorTitle: "Bear Relay", keywords: ["stop", "delete worker", "remove relay", "teardown"] },
  { label: "Forget URL", section: "relay", anchorTitle: "Bear Relay", keywords: ["forget", "clear url", "reset relay", "remove url"] },
  { label: "Use a different URL", section: "relay", anchorTitle: "Bear Relay", keywords: ["change relay", "switch relay", "different url", "replace"] },
  { label: "Deploy mine instead", section: "relay", anchorTitle: "Bear Relay", keywords: ["own relay", "deploy mine", "self host", "migrate"] },
  { label: "Redeploy", section: "relay", anchorTitle: "Bear Relay", keywords: ["redeploy", "update relay", "upgrade", "new version", "redeploy instructions"] },
  { label: "Documentation: run your own relay", section: "relay", anchorTitle: "Bear Relay", keywords: ["docs", "documentation", "guide", "run your own", "instructions"] },
  ...
  { label: "Bear in your browser", section: "p2p", anchorTitle: "Your streaming server address", keywords: ["web ui", "browser app", "serve web", "phone", "tv browser", "11472", "web version"] },
  ...
  { label: "Embed mpv inside Bear window", section: "player", anchorTitle: "Player engine", keywords: ["embedded mpv", "separate window", "inline playback", "detached player", "external window"] },
  ...
  { label: "Catch stremio:// install links inside Bear", section: "advanced", anchorTitle: "Stremio install links", keywords: ["protocol handler", "stremio link handler", "in app installer", "addon install", "default app", "configure and install"] },
  ...
  { label: "Get Bear for desktop", section: "advanced", keywords: ["download desktop app", "desktop version", "web limitations", "install harbor"] },
...
{ label: "Lock to season server", section: "basics", anchorTitle: "How Play works", keywords: ["season lock","season server","season pack","same source","lock source","no re-picking","play mode","sticky season","debrid season pack","lock series"] },
  ...
  { label: "Sign in to Bear", section: "account", anchorTitle: "Bear account", keywords: ["sign in","log in","harbor account","welcome back","authenticate","existing account"] },
  { label: "Create Bear account", section: "account", anchorTitle: "Bear account", keywords: ["create account","register","sign up","join harbor","new account","free account"] },
  { label: "Claim your handle", section: "account", anchorTitle: "Bear account", keywords: ["handle","@handle","claim handle","change handle","username","public handle","find me"] },
  { label: "Reset password (recovery key)", section: "account", anchorTitle: "Bear account", keywords: ["forgot password","reset password","recovery key","backup code","recover account","lost password"] },
  { label: "Sign out of Bear account", section: "account", anchorTitle: "Bear account", keywords: ["sign out","logout","log off","harbor account","disconnect"] },
  { label: "Verified status", section: "account", anchorTitle: "Bear account", keywords: ["verified","verification","verified badge","checkmark","ownership"] },
  ...
  { label: "Home style (Bear curated / Classic Stremio)", section: "library", anchorTitle: "Home layout", keywords: ["home style","harbor curated","classic stremio","home mode","hero carousel","curated home","traditional layout","layout style"] },
  ...
  { label: "Relay version status", section: "relay", anchorTitle: "Bear Relay", keywords: ["relay version","outdated","up to date","current version","update available","protocol"] },
  { label: "Download relay documentation", section: "relay", anchorTitle: "Bear Relay", keywords: ["download docs","export documentation","pdf","txt","json","save docs","print"] },
  ...
  { label: "Liquid glass row arrows", section: "theme", anchorTitle: "Poster card style", keywords: ["liquid glass","row arrows","scroll arrows","glass button","refraction","webgl","glassy arrows"] },
  { label: "Enhanced liquid glass", section: "theme", anchorTitle: "Poster card style", keywords: ["enhanced glass","glass opacity","glass blur","glass tint","richer glass","glass appearance","liquid glass"] },
  ...
  { label: "Clean, transparent top bar", section: "theme", anchorTitle: "Window title bar", keywords: ["transparent top bar","clean top bar","no pill","top bar icons","watch together panel","minimal header"] },
