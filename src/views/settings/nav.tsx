...
const SETTINGS_OPTIONS: SettingsOption[] = [
  ...
  { label: "Harbor on other devices (web app)", section: "remotes", anchorTitle: "Harbor on other devices", keywords: ["harbor in browser", "web ui", "web app", "web version", "11472", "serve", "network", "tv browser", "laptop", "open on phone"] },
  ...
  { label: "Harbor in your browser", section: "p2p", anchorTitle: "Your streaming server address", keywords: ["web ui", "browser app", "serve web", "phone", "tv browser", "11472", "web version"] },
