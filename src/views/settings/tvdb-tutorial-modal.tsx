...
const STEPS: { title: string; body: string; img: string; callout?: boolean }[] = [
  ...
  },
  {
    ...
    body: "For Company / Project Revenue pick 'Less than $50k per year' (Free). Company or Project Name can be anything, like Bear, and 'This is an application that is open sourced!' works for the description.",
    img: tvdb2,
    callout: true,
  },
  {
  ...
  {
    title: "Copy your key",
    body: "The success page shows your secret API key in a box. Copy it (it is also saved in your TheTVDB dashboard), then paste it into the TVDB field in Bear.",
    img: tvdb4,
  },
];
