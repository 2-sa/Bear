      ...
      >
        <div className="flex flex-col gap-1">
          ...
          <span className="text-[13.5px] leading-relaxed text-ink-muted">
            {t("Power-user knob. Inject your own CSS, JS, and HTML into Bear. Lives in your local settings; nothing leaves your machine.")}
          </span>
        </div>
  ...
  return (
    <div className="flex flex-col gap-7">
      <div className="flex items-start gap-2.5 rounded-md border border-danger bg-danger/15 px-3.5 py-3 text-[12.5px] leading-snug text-ink">
        ...
        <span>
          {t("You're modding your own client. Custom JS has full access to your Bear session. Only paste code you wrote or fully trust.")}
        </span>
      </div>
