...
export const WINDOW_HARBOR: HarborApi[] = [
  ...
  { call: "window.harbor.tryViewMyProfile()", desc: "Open the signed-in user's own Bear profile immediately when its handle is loaded. Returns true when navigation starts and false otherwise." },
