  ...
  return (
    <>
      <Section
        ...
        subtitle={t("One switch serves Bear on your network. Scan a code below with your phone, or open an address on any device on the same Wi-Fi.")}
      >
        <ToggleRow
