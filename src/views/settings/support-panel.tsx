...
const CHARITIES = [
  ...
  { name: "Internet Archive", url: "https://archive.org/donate", blurb: "Keeps the web's memory alive. Bear would be poorer without it." },
  ...
  return (
    <>
      <Section
        ...
        subtitle={t("Bear's backend runs on ElfHosted. They run our servers at no cost to the community.")}
      >
        <div className="flex items-start gap-4 rounded-2xl border border-edge-soft bg-canvas/40 p-5">
          ...
          <div className="flex min-w-0 flex-col gap-3">
            <p className="text-[13.5px] leading-relaxed text-ink-muted">
              {t("Keeping Bear's backend online costs real money, and ElfHosted covers it so the community does not have to. Becoming a subscriber is the best way to keep that going, and it is not a donation. You get proper infrastructure for your own setup, and Bear stays funded at the same time.")}
            </p>
      ...
      <Section
        ...
        subtitle={t("Bear would not be possible without Stremio. It is the foundation everything here is built on.")}
      >
        <div className="flex items-start gap-4 rounded-2xl border border-edge-soft bg-canvas/40 p-5">
          ...
          <div className="flex min-w-0 flex-col gap-3">
            <p className="text-[13.5px] leading-relaxed text-ink-muted">
              {t("Bear speaks Stremio's addon protocol, and the whole ecosystem of addons grows out of their work. Stremio is funded by its community, and supporters who chip in get early access to experimental features. If you have it to spare, send some their way too.")}
            </p>
            <div className="flex items-center gap-2.5 rounded-xl bg-elevated/50 px-3.5 py-3">
              ...
              <p className="text-[12.5px] leading-relaxed text-ink-muted">
                {t("Stremio Supporters get a special badge on their Bear profile.")}
              </p>
            </div>
            <div className="mt-1 flex flex-wrap gap-2.5">
      ...
      <Section
        title={t("Donating to Bear")}
        subtitle={t("Short version: don't. Bear takes no donations.")}
      >
        <p className="text-[13.5px] leading-relaxed text-ink-muted">
      ...
      <Section
        ...
        subtitle={t("No affiliation, no referral links, and Bear gets nothing from these. They are just places where money goes further than it does here.")}
      >
        <div className="flex flex-col gap-2.5">
          {CHARITIES.map((c) => (
            <button
