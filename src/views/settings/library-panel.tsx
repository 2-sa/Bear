  ...
  return (
    <>
      ...
      <Section
        ...
        subtitle={t(
          "When you back out of a title, Bear saves a frame so the Continue Watching card looks like the spot you left. Tune how long they stick around, or wipe them all.",
        )}
      >
        <CwSnapshotShowcase />
        <RetentionPicker
      ...
      <Section
        ...
        subtitle={t(
          "Used for streaming availability and the Now Playing release window. Pick a country and Bear can match the interface, metadata, and subtitle languages to it.",
        )}
      >
        <RegionField />
      </Section>
      ...
      <Section
        ...
        subtitle={t(
          "A free TMDB key is highly recommended. It unlocks the full Bear experience. The rest are optional, and Cinemeta works out of the box without any.",
        )}
      >
        <KeyField
      ...
      <Section
        ...
        subtitle={t(
          "Options for the Library → Local tab: folders you scan from your own drive. When you export metadata, Bear writes a Kodi-style .nfo and downloads artwork next to each file at the sizes below.",
        )}
      >
        <ToggleRow
        ...
        <div className="mt-2 flex flex-col gap-4 rounded-xl bg-canvas/40 p-4">
          <div className="flex flex-col gap-0.5">
            ...
            <span className="text-[12px] leading-snug text-ink-muted">
              {t(
                "The resolution Bear downloads for each image when you export a title's metadata next to the file on disk.",
              )}
            </span>
          </div>
