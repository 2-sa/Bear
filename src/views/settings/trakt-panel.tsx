  ...
  return (
    <>
      {!isConnected ? (
        <section className="flex flex-col gap-5 rounded-2xl border border-edge-soft bg-elevated/40 p-7">
          <div className="flex flex-col gap-2">
            ...
            <p className="text-[13.5px] leading-relaxed text-ink-muted">
              {t("Track everything you watch, see your watchlist, and get personalized recommendations on Bear's home page. Free at trakt.tv.")}
            </p>
          </div>
        ...
        <Section
          title={t("Connected")}
          subtitle={t("Bear will scrobble your playback to Trakt and sync your watchlist.")}
        >
          ...
          {traktAvatar && (
            <ToggleRow
              label={t("Use my Trakt avatar as my Bear avatar")}
              sub={t("Wear your Trakt profile picture across Bear instead of the default.")}
      ...
      {isConnected && (
        <Section
          ...
          subtitle={t("Copy your Bear watchlist over to Trakt, or pull your Trakt watchlist into Bear. Safe to run again, Trakt skips anything it already has.")}
        >
          <WatchlistSync />
        </Section>
      )}
