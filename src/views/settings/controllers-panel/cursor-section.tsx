...
export function CursorSection() {
  ...
  return (
    <Section
      ...
      subtitle={t("The pointer your right stick moves around Bear. Pick a shape or use your own image.")}
    >
      <div className="flex flex-col gap-2">
        ...
        <SettingRow
          ...
          desc={t("PNG, WEBP, SVG or GIF. Bear shrinks it to 128px so it stays small on disk.")}
        >
