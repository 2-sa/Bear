...
export function WebhooksPanel() {
  ...
  const send = async (kind: WebhookKind) => {
    ...
    const testPayload: WebhookPayload = {
      text: `Bear test message (${kind === "discord" ? "Discord" : "Telegram"}). If you can read this, your webhook is wired up.`,
      items: [],
    };
    try {
  ...
  return (
    <>
      <Section
        ...
        subtitle={t("Connect Discord or Telegram and Bear posts a message when something you follow is about to drop. Hit Test to send yourself a sample first.")}
      >
