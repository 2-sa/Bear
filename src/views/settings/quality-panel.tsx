  ...
  return (
    <>
          ...
          <div className="flex items-start gap-2.5 rounded-xl border border-amber-400/35 bg-amber-400/10 px-3.5 py-3 text-start">
            ...
            <div className="flex min-w-0 flex-col gap-0.5">
              ...
              <span className="text-[12px] leading-relaxed text-amber-200/85">
                {t(
                  "Live face scanning loads on-device AI models and can significantly increase RAM, CPU, and GPU usage while playback is active. Turn it off if Bear slows down or your device gets hot.",
                )}
              </span>
            </div>
          </div>
      ...
      <Section
        ...
        subtitle={t("Bear finds intro and credits timing from AniSkip, TheIntroDB, and the file's own chapters, then shows a Skip button at the right moment.")}
      >
        <ToggleRow
          label={t("Show the Skip button")}
          sub={t("Show a Skip Intro / Skip Credits button when Bear detects one. Turn this off to never show it. You can also tap the X on the button to dismiss a wrong one for the rest of the episode.")}
