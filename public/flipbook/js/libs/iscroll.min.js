...
!(function (t, i, s) {
        ...
        (e.momentum = function (t, i, e, o, n, r) {
          ...
          return (
            ...
            (h = t + ((c * c) / (2 * r)) * (l < 0 ? -1 : 1)) < o
              ? ((h = n ? o - (n / 2.5) * (c / 8) : o), (a = (l = s.abs(h - t)) / c))
              : h > 0 && ((h = n ? (n / 2.5) * (c / 8) : 0), (a = (l = s.abs(t) + h) / c)),
      ...
      return (
          ...
          elastic: {
            ...
            fn: function (t) {
              return 0 === t
                ...
                : 1 == t
                  ? 1
                  : 0.4 * s.pow(2, -10 * t) * s.sin(((t - 0.055) * (2 * s.PI)) / 0.22) + 1;
            },
          },
        }),
        (e.tap = function (t, s) {
        ...
        (e.click = function (s) {
          ...
          /(SELECT|INPUT|TEXTAREA)/i.test(o.tagName) ||
            ((e = i.createEvent(t.MouseEvent ? "MouseEvents" : "Event")).initEvent("click", !0, !0),
            (e.view = s.view || t),
            (e.detail = 1),
  ...
  function n(e, n) {
    for (var r in ((this.wrapper = "string" == typeof e ? i.querySelector(e) : e),
    ...
    ((this.translateZ = this.options.HWCompositing && o.hasPerspective ? " translateZ(0)" : ""),
      ...
      (this._events = {}),
      (this.scale = s.min(
        s.max(this.options.startZoom, this.options.zoomMin),
  ...
  function h(s, n) {
    for (var r in ((this.wrapper = "string" == typeof n.el ? i.querySelector(n.el) : n.el),
    ...
    if (
      ...
      this.options.interactive &&
        (this.options.disableTouch ||
          (o.addEvent(this.indicator, "touchstart", this), o.addEvent(t, "touchend", this)),
        ...
        this.options.disableMouse ||
          (o.addEvent(this.indicator, "mousedown", this), o.addEvent(t, "mouseup", this))),
      this.options.fade)
    ) {
  ...
  ((n.prototype = {
      ...
      if ("pointerdown" != t.type || t.isPrimary) {
        ...
        if (this.enabled && (!this.initiated || o.eventType[t.type] === this.initiated)) {
          !this.options.preventDefault ||
            o.isBadAndroid ||
            o.preventDefaultException(t.target, this.options.preventDefaultException) ||
            t.preventDefault();
          var i,
    ...
    _move: function (t) {
      if (
        this.enabled &&
        o.eventType[t.type] === this.initiated &&
        ...
        if (
          ...
          ((a = this.hasHorizontalScroll ? a : 0),
            ...
            (i > 0 || i < this.maxScrollX) &&
              (i = this.options.bounce ? this.x + a / 3 : i > 0 ? 0 : this.maxScrollX),
            (e > 0 || e < this.maxScrollY) &&
              (e = this.options.bounce ? this.y + l / 3 : e > 0 ? 0 : this.maxScrollY),
        ...
        if (
          ...
          if (this._events.flick && n < 200 && a < 100 && l < 100) this._execEvent("flick");
            ...
            if (
              ...
              ((this.currentPage = d),
                (c =
                  ...
                  s.max(s.max(s.min(s.abs(r - d.x), 1e3), s.min(s.abs(h - d.y), 1e3)), 300)),
                (r = d.x),
                (h = d.y),
                (this.directionX = 0),
                (this.directionY = 0),
            ...
            if (r != this.x || h != this.y)
              return (
                (r > 0 || r < this.maxScrollX || h > 0 || h < this.maxScrollY) &&
                  (p = o.ease.quadratic),
                this.scrollTo(r, h, c, p),
        ...
        !this.hasHorizontalScroll || this.x > 0
          ? ((i = 0),
            this.options.keepInCenterH &&
              ...
              (i = this.wrapperWidth / 2 - (this.getScrollerWidth() * this.scale) / 2))
        ...
        !this.hasVerticalScroll || this.y > 0
          ? ((s = 0),
            this.options.keepInCenterV &&
              ...
              (s = this.wrapperHeight / 2 - (this.getScrollerHeight() * this.scale) / 2))
    ...
    refresh: function () {
      ...
      var t = o.getRect(this.scroller);
      (this.scrollerW && (t.width = this.scrollerW),
        this.scrollerH && (t.height = this.scrollerH),
        (this.scrollerWidth = s.round(t.width * this.scale)),
        (this.scrollerHeight = s.round(t.height * this.scale)),
        ...
        o.hasPointer &&
          !this.options.disablePointer &&
          ((this.wrapper.style[o.style.touchAction] = o.getTouchAction(
            this.options.eventPassthrough,
            !0,
          )),
          this.wrapper.style[o.style.touchAction] ||
            (this.wrapper.style[o.style.touchAction] = o.getTouchAction(
              this.options.eventPassthrough,
              !1,
            ))),
    ...
    scrollTo: function (t, i, s, e) {
      if (0 != this.wrapperWidth && 0 != this.wrapperHeight) {
        ...
        !s || n
          ? (n && (this._transitionTimingFunction(e.style), this._transitionTime(s)),
            this._translate(t, i))
    ...
    scrollToElement: function (t, i, e, n, r) {
      if ((t = t.nodeType ? t : this.scroller.querySelector(t))) {
        var h = o.offset(t);
        ((h.left -= this.wrapperOffset.left), (h.top -= this.wrapperOffset.top));
        var a = o.getRect(t),
          l = o.getRect(this.wrapper);
        (!0 === e && (e = s.round(a.width / 2 - l.width / 2)),
          !0 === n && (n = s.round(a.height / 2 - l.height / 2)),
          (h.left -= e || 0),
          (h.top -= n || 0),
          ...
          (i =
            null == i || "auto" === i ? s.max(s.abs(this.x - h.left), s.abs(this.y - h.top)) : i),
    ...
    getComputedPosition: function () {
      ...
      return (
        this.options.useTransform
          ? ((i = +((e = e[o.style.transform].split(")")[0].split(", "))[12] || e[4])),
            (s = +(e[13] || e[5])))
          : ((i = +e.left.replace(/[^-\d.]/g, "")), (s = +e.top.replace(/[^-\d.]/g, ""))),
        { x: i, y: s }
      );
    },
    ...
    _zoomStart: function (t) {
      ...
      ((this.touchesDistanceStart = s.sqrt(i * i + e * e)),
        ...
        (this.originX =
          s.abs(t.touches[0].pageX + t.touches[1].pageX) / 2 + this.wrapperOffset.left - this.x),
        (this.originY =
          s.abs(t.touches[0].pageY + t.touches[1].pageY) / 2 + this.wrapperOffset.top - this.y),
    ...
    _zoom: function (t) {
      if (this.enabled && o.eventType[t.type] === this.initiated) {
        ...
        var i,
          e,
          n,
          r = s.abs(t.touches[0].pageX - t.touches[1].pageX),
          h = s.abs(t.touches[0].pageY - t.touches[1].pageY),
          a = s.sqrt(r * r + h * h),
          l = (1 / this.touchesDistanceStart) * a * this.startScale;
        ((this.scaled = !0),
          l < this.options.zoomMin
            ? (l = 0.5 * this.options.zoomMin * s.pow(2, l / this.options.zoomMin))
            : l > this.options.zoomMax &&
              (l = 2 * this.options.zoomMax * s.pow(0.5, this.options.zoomMax / l)),
          (i = l / this.startScale),
    ...
    zoom: function (t, i, s, e) {
      if (
        ...
        (1 != o &&
          ...
          (this.zoomStartTimeout = setTimeout(
            function () {
    ...
    _wheelZoom: function (t) {
      var i, e;
      if ("deltaX" in t) i = -t.deltaY / s.abs(t.deltaY);
    ...
    _wheel: function (t) {
      if (this.enabled) {
        ...
        ((o = this.x + s.round(this.hasHorizontalScroll ? i : 0)),
          ...
          n > 0 ? (n = 0) : n < this.maxScrollY ? (n = this.maxScrollY) : t.preventDefault(),
          this.scrollTo(o, n, 0));
      }
    },
    _initSnap: function () {
        ...
        this.on("refresh", function () {
          ...
          if (
            ...
            if (!0 === this.options.snap)
              for (e = s.round(d / 2), n = s.round(u / 2); p > -this.scrollerWidth; ) {
                for (this.pages[l] = [], t = 0, r = 0; r > -this.scrollerHeight; )
                  ((this.pages[l][t] = {
              ...
              for (t = (h = this.options.snap).length, i = -1; l < t; l++)
                ((a = o.getRect(h[l])),
                  (0 === l || a.left <= o.getRect(h[l - 1]).left) && ((c = 0), i++),
                  this.pages[c] || (this.pages[c] = []),
                  (p = s.max(-a.left, this.maxScrollX)),
                  (r = s.max(-a.top, this.maxScrollY)),
                  (e = p - s.round(a.width / 2)),
                  (n = r - s.round(a.height / 2)),
                  (this.pages[c][i] = {
                    x: p,
                    y: r,
                    width: a.width,
    ...
    goToPage: function (t, i, e, o) {
      ...
      ((e =
        void 0 === e
          ? this.options.snapSpeed ||
            s.max(s.max(s.min(s.abs(n - this.x), 1e3), s.min(s.abs(r - this.y), 1e3)), 300)
          : e),
    ...
    _initKeys: function (i) {
      var s,
        e = { pageUp: 33, pageDown: 34, end: 35, home: 36, left: 37, up: 38, right: 39, down: 40 };
      if ("object" == typeof this.options.keyBindings)
        for (s in this.options.keyBindings)
          "string" == typeof this.options.keyBindings[s] &&
            (this.options.keyBindings[s] = this.options.keyBindings[s].toUpperCase().charCodeAt(0));
      ...
      if (this.enabled) {
        ...
        switch (
          (this.options.useTransition &&
            ...
            this._translate(s.round(i.x), s.round(i.y)),
            (this.isInTransition = !1)),
          (this.keyAcceleration = h - a < 200 ? s.min(this.keyAcceleration + 0.25, 50) : 0),
          t.keyCode)
        ) {
        ...
        e
          ...
          : (n > 0
            ...
            r > 0
              ...
              : r < this.maxScrollY && ((r = this.maxScrollY), (this.keyAcceleration = 0)),
            this.scrollTo(n, r, 0),
            (this.keyTime = h));
      }
    },
    ...
    "undefined" != typeof module && module.exports
      ...
      : "function" == typeof define && define.amd
        ...
        : (t.IScroll = n),
    (t.FLIPBOOK = t.FLIPBOOK || {}),
    (t.FLIPBOOK.IScroll = n),
    (t.PointerEvent = void 0));
