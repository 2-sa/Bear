...
((FLIPBOOK.BookWebGL = class extends FLIPBOOK.Book {
  ...
  init3d() {
    ...
    ((this.Scene = new THREE.Scene()),
      ...
      (this.Camera = new THREE.PerspectiveCamera(30, e, 100, 5e3)),
    ...
    var s = this.wrapper,
      ...
      n = o.getContext("webgl2") || o.getContext("webgl");
    ((this.renderer = new THREE.WebGLRenderer({
      ...
      this.updateRendererSize(s.clientWidth, s.clientHeight),
      s.appendChild(this.renderer.domElement));
    for (var h = !1, a = this.options.pages, r = 0; r < a.length; r++) a[r].htmlContent && (h = !0);
    if (
      ((h || i.pdfMode) && this.initHtmlContent(),
      ...
      var p = i.lightColor,
        d = new THREE.DirectionalLight(p, 0.35 * i.lightIntensity);
      if (((this.directionalLight = d), this.options.shadows)) {
        ((d.castShadow = !0),
          (d.shadow.bias = -0.001),
          d.shadow.mapSize.set(2048, 2048),
          (d.shadow.camera.left = -(this.pageW + 20)),
          (d.shadow.camera.right = this.pageW + 20),
          (d.shadow.camera.top = 0.5 * this.pageH + 20),
          (d.shadow.camera.bottom = -(0.5 * this.pageH + 20)),
          (d.shadow.camera.near = 200),
          (d.shadow.camera.far = 2200),
          (d.shadow.camera.far = 1800),
          (d.shadow.radius = 4));
        var l = new THREE.ShadowMaterial();
        ((l.opacity = 0.35 * this.options.shadowOpacity),
          (this.shadowPlane = new THREE.Mesh(
            new THREE.PlaneGeometry(2.2 * this.pageW, 2 * this.pageH, 1, 1),
            l,
          )),
  ...
  updateRendererSize(t, e) {
    (this.rendererW == t && this.renderH == e) ||
  ...
  updatePixelRatio() {
    let t = this.options.minPixelRatio;
    (this.rendererW < 1200 || this.rendererH < 1200) && (t = 2);
    const e = Math.max(window.devicePixelRatio, t);
    e !== this.pixelRatio && (this.renderer.setPixelRatio(e), (this.pixelRatio = e));
  }
  onPageUnloaded(t) {
    var e,
      i = Math.floor(t / 2);
    (this.options.rightToLeft
      ? ((i = this.pages.length - i - 1), (e = t % 2 == 0 ? "back" : "front"))
      : (e = t % 2 == 0 ? "front" : "back"),
  ...
  correctZOrder() {
    const t = 0.5 * Math.PI,
      ...
      o = FLIPBOOK.th(),
      n = this.shadowPlane;
    ((this._basePowTh = 1 === this._basePowTh || this._lastTh !== o ? e(o, 0.85) : this._basePowTh),
      (this._lastTh = o));
    const h = (this._zLeft ||= []),
      a = (this._zRight ||= []);
    let r = 0;
    ...
    for (let e = 0; e < s; e++) {
      const s = i[e];
      s.angle > t ? h.push(s) : a.push(s);
    }
    h.reverse();
    for (let t = 0, i = h.length; t < i; t++) {
      const i = h[t];
      ((i.container.position.z = -this._basePowTh * e(t, 0.85)),
        (r = Math.min(i.container.position.z, r)),
        (i.cube.castShadow = t < 2));
    }
  ...
  initHtmlContent() {
    ...
    var e = this.options.scaleCover ? 2 : 1,
      i = this.options.scaleCover ? 1 : 2;
    ...
    if (this.isZoomed())
      ...
      if (
        ...
        if (("cancel" == e || "end" == e) && n <= 1) {
          ...
          (!(i > 0) || (a && a.dragging)
            ? !(i < 0) || (h && h.dragging) || this.nextPage()
            : this.prevPage(),
            a && (a.dragging = !1),
            h && (h.dragging = !1));
        } else if ("move" == e && n <= 1) {
          if (this.draggingBook)
            return (
              (this.centerContainer.position.x = this.draggingBookStartX + i),
              this.updateHtmlLayerPosition(),
          ...
          if (1 == this.view && this.isFocusedRight() && i > 0 && this.canFlipPrev())
            return (
              (this.draggingBookStartX = this.centerContainer.position.x),
              void (this.draggingBook = !0)
            );
          if (((i = (180 * i) / this.wrapperW), (h && h.flipping) || (a && a.flipping))) return;
          i > 0 && this.canFlipPrev()
            ? (h && (h._setAngle(180 - i), (h.dragging = !0), this.main.dragPage()),
              a && (a._setAngle(0), (a.dragging = !1)),
              p && p.showMat(),
              r && r.hideMat())
            : i < 0 &&
              this.canFlipNext() &&
              (a && (a._setAngle(-i), (a.dragging = !0), this.main.dragPage()),
              h && (h._setAngle(180), (h.dragging = !1)),
              p && p.hideMat(),
              r && r.showMat());
        }
    }
  ...
  onResize(t) {
    var e = this.main,
      ...
      a = this.bookWidth;
    o.scaleCover && (n /= a);
    var r = i / (s - 2 * e.bookVerticalPadding),
      p = n / h,
      d = Math.min(this.zoom, 1),
      l = Number(o.zoomMin);
    (o.responsiveView && i <= o.responsiveViewTreshold && r < 2 * p && r < o.responsiveViewRatio
      ? ((this.view = 1), (this.sc = p > r ? (l * r) / (p * d) : 1))
      : ((this.view = 2), (this.sc = r < a * p ? (l * r) / (a * p * d) : 1)),
      (this.sc *= (s - 2 * e.bookVerticalPadding) / s),
      (this.Camera.aspect = i / s),
      this.Camera.updateProjectionMatrix(),
      this.updateCameraPosition(),
      this.updateRendererSize(i, s),
      t || this.updateBookPosition(),
      this.htmlLayer &&
        (this.cssRenderer.setSize(i, s), this.htmlLayer.scale.set(this.sc, this.sc, this.sc)),
      this.isFlipping() || this.options.main.turnPageComplete(),
      (this.wrapperW = i),
      (this.wrapperH = s));
  }
  updateCameraPosition() {
    var t,
      ...
      s = (this.options.cameraDistance * Math.cos(e)) / this.zoom,
      o = this.sc;
    (this.options.scaleCover
      ? this.centerContainer.scale.set(o / this.bookWidth, o, o)
  ...
  updateLightPosition() {
    ...
    if (!t) return;
    const e = this.centerContainer.position.x,
      i = this.centerContainer.position.y,
      s = this.sc,
      o = Math.max(this.pageW * s, this.pageH * s) + 100;
    (t.position.set(e - o / 3.5, i + o / 4.5, o),
      t.target.position.set(e, i, 0),
  ...
  updateShadowCamera() {
    ...
    const e = this.sc,
      ...
      s = this.pageH * e,
      o = 100;
    ((t.shadow.camera.left = -(i + o)),
      (t.shadow.camera.right = i + o),
      (t.shadow.camera.top = 0.5 * s + o),
      (t.shadow.camera.bottom = -(0.5 * s + o)),
  ...
  createPages() {
    var t,
      ...
      o = s.options,
      n = o,
      h = o.pageMiddleShadowSize,
      a = document.createElement("canvas");
    ((a.width = 64), (a.height = 64));
    var r = a.getContext("2d"),
      p = r.createLinearGradient(64 - h, 0, 64, 0);
    ((o.pageMiddleShadowColorL = "#b1b1b1ff"),
      (o.pageMiddleShadowColorR = "#d7d7d7ff"),
      p.addColorStop(0, "#CCC"),
      p.addColorStop(1, o.pageMiddleShadowColorL),
      (r.fillStyle = p),
      r.fillRect(0, 0, 64, 64));
    var d = new THREE.CanvasTexture(a);
    ((d.needsUpdate = !0), (s.specularB = d));
    var l = document.createElement("canvas");
    ((l.width = 64), (l.height = 64));
    var g = l.getContext("2d"),
      c = g.createLinearGradient(0, 0, h, 0);
    (c.addColorStop(0, o.pageMiddleShadowColorR),
      c.addColorStop(1, "#CCC"),
      (g.fillStyle = c),
      g.fillRect(0, 0, 64, 64));
    var u = new THREE.CanvasTexture(l);
    n.z = ("string" == typeof n.s && n.s) || "";
    const { z: f } = n;
    var m, M;
    if (((u.needsUpdate = !0), (s.specularF = u), s.options.pagePreloader)) {
      var x = new THREE.TextureLoader().load(s.options.pagePreloader, function () {});
      s.options.lights
        ...
        : (m = M = new THREE.MeshBasicMaterial({ map: x, color: 15592941 }));
    } else
      s.options.lights
        ? ((m = new THREE.MeshStandardMaterial({
            roughness: s.options.pageRoughness,
        ...
        : (m = M = new THREE.MeshBasicMaterial({ color: 15592941 }));
    ...
    var y = FLIPBOOK.th(),
      v = n.pages,
      P = v.length % 2 == 0,
      b = P ? v.length / 2 : (v.length + 1) / 2;
    for (!s.options.cover && P && (b += 1), i = 0; i < b; i++)
      ((t = 0 == i || i == b - 1 ? s.options.coverHardness : s.options.pageHardness),
        (e = new FLIPBOOK.PageWebGL(s, i, t, s.options, m, M)),
        s.pages.push(e),
        s.centerContainer.add(e.container),
        s.flippedright++);
    (this.correctZOrder(), this.bg && (this.bg.position.z = -b * y - 5), (s.initialized = !0));
  }
  getNumPages() {
  ...
  goToPage(t, e, i) {
    ...
    var s = this;
    if (this.initialized) {
      if (!e || !this.isFlipping()) {
        if (
          (t < 0 && (t = 0),
          t > 2 * this.numSheets && (t = 2 * this.numSheets),
          1 == this.view && !i)
        ) {
          var o = e ? 0 : 300;
          t % 2 == 0 ? this.focusLeft(o) : this.focusRight(o);
        }
        if ((t % 2 != 0 && t--, t == this.rightIndex))
          return (this.loadPages(), void this.turnPageComplete());
        if (((this.goingToPage = !0), void 0 !== e && e)) {
          if (t > s.rightIndex) for (; s.rightIndex < t; ) this.nextPageInstant();
          else for (; s.rightIndex > t; ) this.prevPageInstant();
          return (this.updateBookPosition(), this.loadPages(), void this.turnPageComplete());
        }
        var n = this.rightIndex > t ? this.rightIndex - 2 : this.rightIndex,
          h = this.pages[n / 2].pageHardness,
          a =
            h == this.options.coverHardness &&
            this.options.coverHardness > this.options.pageHardness
              ? 200
              : 1;
        ((a *= Math.pow(h, 0.5)),
          this.rightIndex > t
            ? this.rightIndex - 2 > t
              ...
              : setTimeout(
                  function () {
                    if ((s.prevPage(), void 0 !== e && e))
                      for (var t = 0; t < s.pages.length; t++)
                        s.pages[t].duration = s.options.pageFlipDuration;
                    s.loadPages();
                  },
                  a,
                )
  ...
  nextPageInstant() {
    if (0 != this.flippedright) {
      var t;
      for (t = 0; t < this.pages.length; t++) if (this.pages[t].flippingRight) return;
      if (1 == this.view) {
        if (this.isFocusedLeft()) {
          if (!this.goingToPage) return (this.focusRight(0), void this.turnPageComplete());
          this.focusLeft(0, 0);
        }
  ...
  prevPageInstant(t) {
    if (0 != this.flippedleft) {
      if (1 == this.view) {
        if (!this.goingToPage) {
          if (this.isFocusedRight()) return (this.focusLeft(0), void this.turnPageComplete());
          this.focusRight(0, 0);
        }
  ...
  nextPage(t = !0) {
    if (this.canFlipNext()) {
      var e;
      for (this.clickedPage = null, e = 0; e < this.pages.length; e++)
        ...
        if (i) {
          ...
          if (s || this.options.backCover || this.options.rightToLeft) {
            if (
              (s && s.showMat(),
              1 == this.view
                ? this.goingToPage || this.focusLeft(600, 200)
                : 1 == this.flippedright && this.options.cover
              ...
              (t &&
                (this.loadNextSpread(),
                (o = function (t) {
                  (n.loadPages(), n.turnPageComplete());
                })),
                i.flipLeft(o));
            }
      ...
      } else this.focusRight(300, 0, this.turnPageComplete);
    }
  }
  updateBookPosition() {
    (1 == this.view
      ...
      : 0 == this.rightIndex
        ? this.focusRight()
        : this.rightIndex >= this.options.numPages && this.options.cover
          ? this.focusLeft()
          : this.focusBoth(),
      this.updateHtmlLayerPosition(),
      this.updateLightPosition(),
  ...
  updateCornerCurl() {
    this.options.cornerCurl &&
      this.pages[0] &&
      (0 == this.flippedleft ? this.pages[0].startCornerCurl() : this.pages[0].stopCornerCurl());
  }
  isFlipping() {
    const t = this.pages;
    for (var e = 0; e < t.length; e++) {
      const i = t[e];
      if (i.flippingLeft || i.flippingRight) return !0;
    }
    return !1;
  }
  async loadPages() {
    var t = this,
      e = this.pages,
      i = this.options.main;
    if (i.wrapperH && i.zoom && !this.isFlipping()) {
      var s = this.pages[this.flippedleft],
        o = this.pages[this.flippedleft - 1],
        n = this.updateHtmlLayer,
        h = this.loadMorePages;
      (e.forEach((e) => {
        ((e !== s && e !== o) || e.showMat(),
          o && e.index < o.index - 2 && (e.hideMat(), t.options.pdfMode || e.disposeMat()),
          s && e.index > s.index + 2 && (e.hideMat(), t.options.pdfMode || e.disposeMat()));
      }),
        i.setLoadingProgress(0.1),
        await this.loadPageAsync(o, "back"),
        this.pageLoaded(o, "back"),
        await this.loadPageAsync(s, "front"),
        this.pageLoaded(s, "front"),
        i.setLoadingProgress(1),
        await this.loadHTMLAsync(o, "back"),
        await this.loadHTMLAsync(s, "front"),
        n.call(t),
        this.unloadPages(),
        h.call(t));
    }
  ...
  unloadPages() {
    let t = this.getLeftPage(),
      e = this.getRightPage(),
      i = this.options.pagesInMemory / 2;
    this.pages.forEach(function (s) {
      (t && Math.abs(s.index - t.index) > i && (s.unload("front"), s.unload("back")),
        e && Math.abs(s.index - e.index) > i && (s.unload("front"), s.unload("back")));
    });
  }
  loadPageImage(t, e, i) {}
  focusLeft(t, e, i) {
    var s = 0.5 * this.options.pageWidth;
    this.moveToPos({ x: s, y: 0, bookWidth: 1 }, t, e, i);
  }
  focusRight(t, e, i) {
    var s = 0.5 * -this.options.pageWidth;
    this.moveToPos({ x: s, y: 0, bookWidth: 1 }, t, e, i);
  ...
  focusBoth(t, e, i) {
    this.moveToPos({ x: 0, y: 0, bookWidth: 2 }, t, e, i);
  }
  moveToPos(t, e, i, s) {
    if (e && this.movingTo != t && this.centerContainer.position.x != t.x) {
      ((this.movingTo = t), this.bookMoveTween && this.bookMoveTween.stop());
      var o = this.centerContainer.position.x,
        n = this.centerContainer.position.y,
        h = t.x,
        a = t.y,
        r = { start: this.bookWidth, end: t.bookWidth };
      ((this.bookMoveTween = FLIPBOOK.animate({
        ...
        step: (t) => {
          (r.start != r.end &&
            ((this.bookWidth = r.start + (r.end - r.start) * t), this.onResize(!0)),
            (this.centerContainer.position.x = o + (h * this.centerContainer.scale.x - o) * t),
            (this.centerContainer.position.y = n + (a * this.centerContainer.scale.x - n) * t),
            this.updateHtmlLayerPosition(),
            this.updateLightPosition());
        },
        complete: () => {
      ...
      (this.movingTo ||
        (this.bookWidth != t.bookWidth && (this.bookWidth = t.bookWidth),
        (this.centerContainer.position.x = t.x * this.centerContainer.scale.x),
        (this.centerContainer.position.y = t.y * this.centerContainer.scale.y)),
        s && s.call(this));
  }
  isFocusedLeft() {
  ...
  prevPage(t = !0) {
    if (this.canFlipPrev()) {
        ...
        if (i && (1 != this.flippedleft || this.options.cover)) {
          ...
          if (s || !this.options.rightToLeft || this.options.backCover) {
            if (
              (s && s.showMat(),
              1 == this.view
                ? this.goingToPage || this.focusRight(600, 200)
                : 1 == this.flippedleft
      ...
      } else this.focusLeft(300, 0, this.turnPageComplete);
    }
  }
  firstPage() {}
  flipFinnished() {
    (this.correctZOrder(), (this.needsUpdate = !0));
  }
  lastPage() {}
  updateVisiblePages() {}
  async loadPrevSpread() {
    ...
    (await this.loadPageAsync(e, "back"),
      this.pageLoaded(e, "back"),
      await this.loadPageAsync(t, "front"),
      this.pageLoaded(t, "front"));
  }
  async loadNextSpread() {
    const t = this.pages[this.flippedleft],
      e = this.pages[this.flippedleft + 1];
    (await this.loadPageAsync(t, "back"),
      this.pageLoaded(t, "back"),
      await this.loadPageAsync(e, "front"),
      this.pageLoaded(e, "front"));
  }
  loadMorePages() {
    (this.loadNextSpread(), this.loadPrevSpread());
  }
  _hideHTMLPage(t) {
    t.htmlHidden || ((t.style.display = "none"), (t.htmlHidden = !0));
  }
  _showHTMLPage(t) {
    t.htmlHidden && ((t.style.display = "block"), (t.htmlHidden = !1));
  }
  _emptyHTMLPage(t) {
  ...
  _addHTMLContent(t, e) {
    ((e.innerHTML = ""),
      e.appendChild(t[0] || t),
      (e.emptyHTML = !1),
      this.startPageItems(t[0] || t));
  }
  updateHtmlLayer(t) {
    if (this.htmlLayer) {
      for (var e = 0; e < this.pages.length; e++) if (this.pages[e].flipping) return;
      if (t || this.htmlContentRightIndex != this.rightIndex) {
        ((this.htmlContentRightIndex = this.rightIndex), (this.htmlLayerVisible = !1));
        var i,
          s = this.pages[this.flippedleft],
          o = this.pages[this.flippedleft - 1],
          n = -1,
          h = -1;
        (s && (n = s.indexF),
          ...
          this.options.doublePage
            ? 0 == this.rightIndex
              ? (n > -1 && (i = this.options.pages[n].htmlContent),
                i &&
                  (this._addHTMLContent(i, this.pageRInner),
                  this._showHTMLPage(this.pageR),
                  (this.htmlLayerVisible = !0)))
              : this.rightIndex == 2 * this.pages.length
                ? (h > -1 && (i = this.options.pages[h].htmlContent),
                  i &&
                    (this._addHTMLContent(i, this.pageLInner),
                    this._showHTMLPage(this.pageL),
                    (this.htmlLayerVisible = !0)))
                : (h > -1
                    ? (i = this.options.pages[h].htmlContent)
                    : n > -1 && (i = this.options.pages[n].htmlContent),
                  i &&
                    (this._addHTMLContent(i, this.pageCInner),
                    this._showHTMLPage(this.pageC),
                    (this.htmlLayerVisible = !0)))
            : (0 != this.rightIndex &&
                (h > -1 && (i = this.options.pages[h].htmlContent),
                i &&
                  (this._addHTMLContent(this.options.pages[h].htmlContent, this.pageLInner),
                  this._showHTMLPage(this.pageL),
                  (this.htmlLayerVisible = !0))),
              this.rightIndex != 2 * this.pages.length &&
                (n > -1 && (i = this.options.pages[n].htmlContent),
                i &&
                  (this._addHTMLContent(this.options.pages[n].htmlContent, this.pageRInner),
                  this._showHTMLPage(this.pageR),
                  (this.htmlLayerVisible = !0)))),
  ...
  zoomTo(t, e, i, s) {
    if (!this.zooming && this.pages.length) {
      ...
      if (void 0 !== i && void 0 !== s) {
        var n,
          h = (this.zoom * this.wrapper.clientHeight) / 1e3,
          a = (t * this.wrapper.clientHeight) / 1e3,
          r = this.centerContainer.position,
          p = {
            ...
            (this.zoomAnimation = FLIPBOOK.animate({
              ...
              step: (e) => {
                ((this.zoom = t + (i - t) * e),
                  ...
                  this.updateCameraPosition(),
                  this.htmlLayer &&
                    ((this.htmlLayer.position.x = s + (h - s) * e),
  ...
  tiltTo(t) {
    ...
    ((e =
      (e = e > this.options.tiltMax ? this.options.tiltMax : e) < this.options.tiltMin
  ...
  panTo(t) {
    ...
    ((e =
      (e = e > this.options.panMax ? this.options.panMax : e) < this.options.panMin
        ? this.options.panMin
        : e),
      (this.pan = e),
      this.updateCameraPosition());
  ...
  _move(t, e, i) {
    if (0 != e || 0 != i) {
      this.moved = !0;
      let t = ((this.zoom * this.wrapperH) / 1e3) * this.sc;
      (this.moveToPos({
        x: this.centerContainerStart.x / this.sc + e / t,
        y: this.centerContainerStart.y / this.sc - i / t,
      }),
        this.updateHtmlLayerPosition(),
        this.updateLightPosition());
    }
  ...
  _end(t) {
    ((this.mouseDown = !1), (this.pageMouseDown = !1), (this.moved = !1));
  }
  enable() {
    (this.enabled ||
      ((this.enabled = !0),
      this.initialized ||
        (this.init3d(), this.createPages(), (this.rendering = !1), this.onResize()),
      this.render(!0)),
      this.onResize());
  }
  disable() {
  ...
  destroy() {
    ...
    function e(i, s) {
      if (i && s) {
        for (; s.children.length > 0; ) e(i, s.children[0]);
        (s.parent && s.parent.remove(s),
          (function (e) {
            e &&
              (e.geometry && e.geometry.dispose(),
              e.material &&
                (Array.isArray(e.material) ? e.material.forEach((e) => t(e)) : t(e.material)));
          })(s));
      }
    }
    var i;
    (!(function (t) {
      if (t) for (; t.children.length > 0; ) e(t, t.children[0]);
    })(this.Scene),
      (i = this.renderer) &&
        (i.dispose(),
        i.domElement &&
          i.domElement.parentNode &&
          i.domElement.parentNode.removeChild(i.domElement)),
  ...
  (FLIPBOOK.PageWebGL = class {
    constructor(t, e, i, s, o, n) {
      ((this.container = new THREE.Object3D()),
        ...
        (this.options = s));
      const { pages: h, rightToLeft: a, cover: r, doublePage: p } = s,
        d = Math.ceil(h.length / 2),
        l = a ? d - this.index - 1 : this.index;
      let g = a ? 2 * l + 1 : 2 * l,
        c = a ? 2 * l : 2 * l + 1;
      if (!r) {
        const t = a ? 1 : -1;
      ...
      (a && p && (c > 0 && c--, g++),
        ...
        (this.preloaderMatF = o),
        (this.preloaderMatB = n),
        (this.htmlLoaded = { front: !1, back: !1 }),
        (this.animations = []));
      var u = this;
      if (0 == e && this.options.cornerCurl) {
        ((this.nfacesw = 20), (this.nfacesh = 20));
        ((this.cornerCurlTween = FLIPBOOK.animate({
          ...
          step: function (t) {
            u.cornerCurl &&
              ((u.b2.force = -1.8 * t), u.modF && u.modF.apply(), (u.book.needsUpdate = !0));
          },
        })),
      ...
      var f,
        m = new THREE.MeshBasicMaterial({ color: 15592941 }),
        M = [m, m, m, m, o, n];
      ((f = [m, m, m, m, m, m]),
        this.options.pagePreloader && (f = [m, m, m, m, o, n]),
        (this.cube = new THREE.Mesh(this.gF, M)),
        (this.cube.position.x = 0.5 * this.pW),
        this.options.shadows && ((this.cube.castShadow = !0), (this.cube.receiveShadow = !0)),
    ...
    stopCornerCurl() {
      ((this.cornerCurl = !1), (this.b2.force = 0), this.modF && this.modF.apply());
    }
    loadHTML(t, e) {
      ...
      this.htmlLoaded[t]
        ...
        : this.options.main.loadPageHTML(i, function (i) {
            ((s.htmlLoaded[t] = !0), e.call(s));
          });
    }
    load(t, e, i, s) {
      var o = this.book.main;
      if (!o.wrapperH) return;
      if (!o.zoom) return;
      var n = this;
      this.disposed = !1;
      var h = this.book.options;
      const { s: a } = h;
      if ("front" == t) {
        if (!h.cover && 0 == this.index) return;
        this.sizeFront == e
          ? i && i.call(this)
          : o.loadPage(this.indexF, e, function (s) {
              if (n.disposed) return;
              if (!s || a) return void (i && i.call(n));
              if (n.sizeFront == e) return void (i && i.call(n));
              n.sizeFront = e;
              const o = h.pages[n.indexF].side,
                r = n.createTexture(s, e, o),
                p = n.createMaterial(r, t);
              ((n.materials = n.materials || {}),
                (n.materials[t] = n.materials[t] || {}),
                (n.materials[t][e] = p),
                i && i.call(n));
            });
      } else if ("back" == t) {
        if (!h.cover && this.index == this.book.pages.length - 1) return;
        this.sizeBack == e
          ? i && i.call(this)
          : o.loadPage(this.indexB, e, function (s) {
              if (n.disposed) return;
              if (!s || a) return void (i && i.call(n));
              if (n.sizeBack == e) return void (i && i.call(n));
              n.sizeBack = e;
              const o = h.pages[n.indexB].side,
                r = n.createTexture(s, e, o),
                p = n.createMaterial(r, t);
              ((n.materials = n.materials || {}),
                (n.materials[t] = n.materials[t] || {}),
    ...
    loaded(t) {
      const e = this.book.currentPageTextureSize;
      this.materials && this.materials[t] && this.setMat(this.materials[t][e], t);
    }
    createTexture(t, e, i) {
      let s;
      if (t.imageBitmap) {
        const i = t.imageBitmap[e] || t.imageBitmap;
        ((s = new THREE.Texture(i)), (s.offset.y = 1), (s.repeat.y = -1));
      } else
        ((s = new THREE.Texture()),
          (s.image = t.image[e] ? t.image[e].clone || t.image[e] : t.image));
      return (
        "left" == i ? (s.repeat.x = 0.5) : "right" == i && ((s.repeat.x = 0.5), (s.offset.x = 0.5)),
    ...
    unload(t) {
      var e, i;
      (this._sidePromises && this._sidePromises[t] && delete this._sidePromises[t],
        "front" == t && this.sizeFront
          ? ((i = (e = this.cube.material[4]).map),
            e.dispose(),
            (e.needsUpdate = !0),
            i && (i.dispose(), (i = null)),
            (this.sizeFront = 0),
    ...
    disposeMat() {
      if (this.loaded) {
        var t = this.cube.material[4],
          ...
          i = t.map,
          s = e.map;
        (t.dispose(), e.dispose(), i && i.dispose(), s && s.dispose(), (this.disposed = !0));
      }
    }
    createMaterial(t, e) {
      var i;
    ...
    _setAngle(t) {
      if (t <= 180 && t >= -180) {
        if (((t = (t / 180) * Math.PI) < 0 && (t += Math.PI), this.angle == t)) return;
        ((this.angle = t),
          (this.container.rotation.y = -t),
          this.isFlippedLeft
            ? (this.bendF.force =
    ...
    hideMat() {
      this.showing &&
        (this.container.remove(this.cube), this.container.add(this.cubeEmpty), (this.showing = !1));
    }
    showMat() {
      this.showing ||
    ...
    setMat(t, e) {
      const i = "front" == e ? 4 : 5;
      this.cube.material[i] !== t && ((this.cube.material[i] = t), (this.book.needsUpdate = !0));
    }
    flipRightInstant(t) {
      ((this.onComplete = t),
        (this.dragging = !1),
    ...
    flipRight(t) {
      ((this.onComplete = t),
        ...
        this.isFlippedRight ||
          ...
          this.index != this.book.getNumPages() - this.book.flippedright - 1 ||
          (this.duration > 0
            ? ((this.flippingRight = !0), (this.flipping = !0), (this.force = 0), this.bendIn(0))
    ...
    bendIn(t) {
      var e =
        2 * this.duration * 240 * Math.pow(Math.abs(this.container.rotation.y - t) / Math.PI, 0.5);
      ((e *= Math.pow(this.pageHardness, 0.25)), (e *= 1 + this.pageHardness / 30));
      var i = this.container.rotation.y,
        s = t,
        o = FLIPBOOK.animate({
          from: i,
          to: s,
      ...
      (this.animations.push(o), this.options.main.turnPageStart());
    }
    bendOut() {
      var t = this.duration * Math.pow(Math.abs(this.bendF.force), 0.5) * 1e3,
        e = this.bendF.force,
        i = this.bendF.offset,
        s = FLIPBOOK.animate({
          from: e,
          ...
          easing: "easeOutSine",
          step: (t) => {
            ((this.bendF.force = t), this.updateBend());
          },
          complete: () => {
      ...
      var o = FLIPBOOK.animate({
        from: i,
        to: 1,
        duration: t,
        easing: "easeOutSine",
        step: (t) => {
          ((this.bendF.offset = t), this.updateBend());
        },
        complete: () => {
          ((this.bendF.offset = 0), this.book.updateCornerCurl());
        },
      });
...
(!(function (t) {
  ...
  (function (t) {
    ...
    ((t.XMath = {}),
      ...
      (t.XMath.inRange = function (t, e, i, s) {
        return (void 0 === s && (s = !1), s ? i >= t && i <= e : i > t && i < e);
      }),
  ...
  (function (t) {
    ((t.Matrix4 = function (t, e, i, s, o, n, h, a, r, p, d, l, g, c, u, f) {
      ((this.n11 = 1),
      ...
      (t.Matrix4.prototype.calculateMultiply = function (t, e) {
        var i = t.n11,
          ...
          w = t.n34,
          L = e.n34;
        ((this.n11 = i * s + r * n + u * a),
          (this.n12 = i * p + r * l + u * c),
          (this.n13 = i * f + r * M + u * y),
          (this.n14 = i * P + r * C + u * L + v),
          (this.n21 = o * s + d * n + m * a),
          (this.n22 = o * p + d * l + m * c),
          (this.n23 = o * f + d * M + m * y),
          (this.n24 = o * P + d * C + m * L + b),
          (this.n31 = h * s + g * n + x * a),
          (this.n32 = h * p + g * l + x * c),
          (this.n33 = h * f + g * M + x * y),
          (this.n34 = h * P + g * C + x * L + w));
      }),
    ...
    ((t.MeshProxy = function () {
      ...
      (t.MeshProxy.prototype.analyzeGeometry = function () {
        ...
        for (
          ...
          (e = l[c]).setRatios((e.getX() - n) / i, (e.getY() - a) / s, (e.getZ() - p) / M);
      }),
      ...
      (t.MeshProxy.prototype.collapseGeometry = function () {
        for (var t = this.getVertices(), e = t.length; --e >= 0; ) t[e].collapse();
        ...
        if (0 != this.force)
          for (
            var e,
              ...
              u = this.m2,
              f = p + a * r,
              m = a / Math.PI / this.force,
              M = t.Constants.doublePI * (a / (m * t.Constants.doublePI)),
              x = 1 / a,
              y = t.Constants.halfPI,
              v = Math.sin,
              P = Math.cos;
            --h >= 0;
          )
            ((e = (a = n[h]).getValue(d)),
              (i = a.getValue(g)),
              (s = a.getValue(l)),
              (e = (i = c.transformPoint(new t.Point(e, i))).x),
              (i = i.y),
              (o = (e - p) * x),
              (this.constraint == t.ModConstant.LEFT && o <= r) ||
                (this.constraint == t.ModConstant.RIGHT && o >= r) ||
                ((e = v((o = y - M * r + M * o)) * (m + s)),
                (o = P(o) * (m + s)),
                (s = e - m),
                (e = f - o)),
  ...
  (function (t) {
    ((t.MeshThree = function () {}),
      ...
      (t.MeshThree.prototype.setMesh = function (e) {
        ...
        for (s = 0; s < a; )
          ((n = new t.FaceProxy()),
            h[s] instanceof THREE.Face3
              ? (n.addVertex(e[o[h[s].a]]), n.addVertex(e[o[h[s].b]]), n.addVertex(e[o[h[s].c]]))
              : h[s] instanceof THREE.Face4 &&
                (n.addVertex(e[o[h[s].a]]),
  ...
  (FLIPBOOK.CSS3DRenderer = function () {
    var t,
      ...
      o = this,
      n = new THREE.Matrix4(),
      h = { camera: { fov: 0, style: "" }, objects: new WeakMap() },
    ...
    function g(t, e) {
      var o = t.elements,
        n =
          ...
          ")";
      return p
        ? "translate(-50%,-50%)translate(" + i + "px," + s + "px)" + e + n
        : "translate(-50%,-50%)" + n;
    }
    function c(t, e, i, s) {
      if (t instanceof FLIPBOOK.CSS3DObject) {
        ...
        (t.onBeforeRender(o, e, i),
          t instanceof FLIPBOOK.CSS3DSprite
            ? (n.copy(i.matrixWorldInverse),
              n.transpose(),
        ...
        if (void 0 === l || l.style !== a) {
          ((d.style.WebkitTransform = a), (d.style.transform = a));
          var u = { style: a };
          (p && (u.distanceToCameraSquared = m(i, t)), h.objects.set(t, u));
        }
        (d.parentNode !== r && r.appendChild(d), t.onAfterRender(o, e, i));
      }
      for (var f = 0, M = t.children.length; f < M; f++) c(t.children[f], e, i, s);
    }
    ...
    function M(t) {
      for (
        var e = (function (t) {
            ...
            return (
              h.objects.get(t).distanceToCameraSquared - h.objects.get(e).distanceToCameraSquared
            );
          }),
          i = e.length,
          s = 0,
      ...
      if (
        (h.camera.fov !== o &&
          (e.isPerspectiveCamera
            ? ((a.style.WebkitPerspective = o + "px"), (a.style.perspective = o + "px"))
            : ((a.style.WebkitPerspective = ""), (a.style.perspective = "")),
          (h.camera.fov = o)),
        ...
        var n = -(e.right + e.left) / 2,
          g = (e.top + e.bottom) / 2;
      var u = e.isOrthographicCamera
          ? "scale(" + o + ")translate(" + d(n) + "px," + d(g) + "px)" + l(e.matrixWorldInverse)
          : "translateZ(" + o + "px)" + l(e.matrixWorldInverse),
        f = u + "translate(" + i + "px," + s + "px)";
      (h.camera.style === f ||
        p ||
        ((r.style.WebkitTransform = f), (r.style.transform = f), (h.camera.style = f)),
        c(t, t, e, u),
        p && M(t));
    };
  }));
